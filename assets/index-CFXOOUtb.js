 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ti="[DEFAULT]",Oh={[ei]:"fire-core",[uh]:"fire-core-compat",[hh]:"fire-analytics",[dh]:"fire-analytics-compat",[mh]:"fire-app-check",[fh]:"fire-app-check-compat",[ph]:"fire-auth",[gh]:"fire-auth-compat",[yh]:"fire-rtdb",[vh]:"fire-data-connect",[_h]:"fire-rtdb-compat",[Eh]:"fire-fn",[bh]:"fire-fn-compat",[Th]:"fire-iid",[wh]:"fire-iid-compat",[Ih]:"fire-fcm",[Ah]:"fire-fcm-compat",[Sh]:"fire-perf",[Rh]:"fire-perf-compat",[Ch]:"fire-rc",[Ph]:"fire-rc-compat",[Dh]:"fire-gcs",[Vh]:"fire-gcs-compat",[xh]:"fire-fst",[kh]:"fire-fst-compat",[Nh]:"fire-vertex","fire-js":"fire-js",[Lh]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qh=1024,Wh=30;class Kh{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new Xh(t),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){var e,t;try{const r=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),o=Ia();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===o||this._heartbeatsCache.heartbeats.some(a=>a.date===o))return;if(this._heartbeatsCache.heartbeats.push({date:o,agent:r}),this._heartbeatsCache.heartbeats.length>Wh){const a=Zh(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(a,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(s){Ye.warn(s)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=Ia(),{heartbeatsToSend:s,unsentEntries:r}=Yh(this._heartbeatsCache.heartbeats),o=Ns(JSON.stringify({version:2,heartbeats:s}));return this._heartbeatsCache.lastSentHeartbeatDate=t,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),o}catch(t){return Ye.warn(t),""}}}function Ia(){return new Date().toISOString().substring(0,10)}function Yh(n,e=Qh){const t=[];let s=n.slice();for(const r of n){const o=t.find(a=>a.agent===r.agent);if(o){if(o.dates.push(r.date),Aa(t)>e){o.dates.pop();break}}else if(t.push({agent:r.agent,dates:[r.date]}),Aa(t)>e){t.pop();break}s=s.slice(1)}return{heartbeatsToSend:t,unsentEntries:s}}class Xh{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Fd()?$d().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await Jh(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const s=await this.read();return wa(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??s.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const s=await this.read();return wa(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...e.heartbeats]})}else return}}function Aa(n){return Ns(JSON.stringify({version:2,heartbeats:n})).length}function Zh(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let s=1;s<n.length;s++)n[s].date<t&&(t=n[s].date,e=s);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ef(n){Ms(new Mn("platform-logger",e=>new lh(e),"PRIVATE")),Ms(new Mn("heartbeat",e=>new Kh(e),"PRIVATE")),Qt(ei,ba,n),Qt(ei,ba,"esm2020"),Qt("fire-js","")}ef("");var tf="firebase",nf="12.10.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Qt(tf,nf,"app");var Sa=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var dt,Jl;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(T,_){function v(){}v.prototype=_.prototype,T.F=_.prototype,T.prototype=new v,T.prototype.constructor=T,T.D=function(b,g,w){for(var y=Array(arguments.length-2),U=2;U<arguments.length;U++)y[U-2]=arguments[U];return _.prototype[g].apply(b,y)}}function t(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(s,t),s.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function r(T,_,v){v||(v=0);const b=Array(16);if(typeof _=="string")for(var g=0;g<16;++g)b[g]=_.charCodeAt(v++)|_.charCodeAt(v++)<<8|_.charCodeAt(v++)<<16|_.charCodeAt(v++)<<24;else for(g=0;g<16;++g)b[g]=_[v++]|_[v++]<<8|_[v++]<<16|_[v++]<<24;_=T.g[0],v=T.g[1],g=T.g[2];let w=T.g[3],y;y=_+(w^v&(g^w))+b[0]+3614090360&4294967295,_=v+(y<<7&4294967295|y>>>25),y=w+(g^_&(v^g))+b[1]+3905402710&4294967295,w=_+(y<<12&4294967295|y>>>20),y=g+(v^w&(_^v))+b[2]+606105819&4294967295,g=w+(y<<17&4294967295|y>>>15),y=v+(_^g&(w^_))+b[3]+3250441966&4294967295,v=g+(y<<22&4294967295|y>>>10),y=_+(w^v&(g^w))+b[4]+4118548399&4294967295,_=v+(y<<7&4294967295|y>>>25),y=w+(g^_&(v^g))+b[5]+1200080426&4294967295,w=_+(y<<12&4294967295|y>>>20),y=g+(v^w&(_^v))+b[6]+2821735955&4294967295,g=w+(y<<17&4294967295|y>>>15),y=v+(_^g&(w^_))+b[7]+4249261313&4294967295,v=g+(y<<22&4294967295|y>>>10),y=_+(w^v&(g^w))+b[8]+1770035416&4294967295,_=v+(y<<7&4294967295|y>>>25),y=w+(g^_&(v^g))+b[9]+2336552879&4294967295,w=_+(y<<12&4294967295|y>>>20),y=g+(v^w&(_^v))+b[10]+4294925233&4294967295,g=w+(y<<17&4294967295|y>>>15),y=v+(_^g&(w^_))+b[11]+2304563134&4294967295,v=g+(y<<22&4294967295|y>>>10),y=_+(w^v&(g^w))+b[12]+1804603682&4294967295,_=v+(y<<7&4294967295|y>>>25),y=w+(g^_&(v^g))+b[13]+4254626195&4294967295,w=_+(y<<12&4294967295|y>>>20),y=g+(v^w&(_^v))+b[14]+2792965006&4294967295,g=w+(y<<17&4294967295|y>>>15),y=v+(_^g&(w^_))+b[15]+1236535329&4294967295,v=g+(y<<22&4294967295|y>>>10),y=_+(g^w&(v^g))+b[1]+4129170786&4294967295,_=v+(y<<5&4294967295|y>>>27),y=w+(v^g&(_^v))+b[6]+3225465664&4294967295,w=_+(y<<9&4294967295|y>>>23),y=g+(_^v&(w^_))+b[11]+643717713&4294967295,g=w+(y<<14&4294967295|y>>>18),y=v+(w^_&(g^w))+b[0]+3921069994&4294967295,v=g+(y<<20&4294967295|y>>>12),y=_+(g^w&(v^g))+b[5]+3593408605&4294967295,_=v+(y<<5&4294967295|y>>>27),y=w+(v^g&(_^v))+b[10]+38016083&4294967295,w=_+(y<<9&4294967295|y>>>23),y=g+(_^v&(w^_))+b[15]+3634488961&4294967295,g=w+(y<<14&4294967295|y>>>18),y=v+(w^_&(g^w))+b[4]+3889429448&4294967295,v=g+(y<<20&4294967295|y>>>12),y=_+(g^w&(v^g))+b[9]+568446438&4294967295,_=v+(y<<5&4294967295|y>>>27),y=w+(v^g&(_^v))+b[14]+3275163606&4294967295,w=_+(y<<9&4294967295|y>>>23),y=g+(_^v&(w^_))+b[3]+4107603335&4294967295,g=w+(y<<14&4294967295|y>>>18),y=v+(w^_&(g^w))+b[8]+1163531501&4294967295,v=g+(y<<20&4294967295|y>>>12),y=_+(g^w&(v^g))+b[13]+2850285829&4294967295,_=v+(y<<5&4294967295|y>>>27),y=w+(v^g&(_^v))+b[2]+4243563512&4294967295,w=_+(y<<9&4294967295|y>>>23),y=g+(_^v&(w^_))+b[7]+1735328473&4294967295,g=w+(y<<14&4294967295|y>>>18),y=v+(w^_&(g^w))+b[12]+2368359562&4294967295,v=g+(y<<20&4294967295|y>>>12),y=_+(v^g^w)+b[5]+4294588738&4294967295,_=v+(y<<4&4294967295|y>>>28),y=w+(_^v^g)+b[8]+2272392833&4294967295,w=_+(y<<11&4294967295|y>>>21),y=g+(w^_^v)+b[11]+1839030562&4294967295,g=w+(y<<16&4294967295|y>>>16),y=v+(g^w^_)+b[14]+4259657740&4294967295,v=g+(y<<23&4294967295|y>>>9),y=_+(v^g^w)+b[1]+2763975236&4294967295,_=v+(y<<4&4294967295|y>>>28),y=w+(_^v^g)+b[4]+1272893353&4294967295,w=_+(y<<11&4294967295|y>>>21),y=g+(w^_^v)+b[7]+4139469664&4294967295,g=w+(y<<16&4294967295|y>>>16),y=v+(g^w^_)+b[10]+3200236656&4294967295,v=g+(y<<23&4294967295|y>>>9),y=_+(v^g^w)+b[13]+681279174&4294967295,_=v+(y<<4&4294967295|y>>>28),y=w+(_^v^g)+b[0]+3936430074&4294967295,w=_+(y<<11&4294967295|y>>>21),y=g+(w^_^v)+b[3]+3572445317&4294967295,g=w+(y<<16&4294967295|y>>>16),y=v+(g^w^_)+b[6]+76029189&4294967295,v=g+(y<<23&4294967295|y>>>9),y=_+(v^g^w)+b[9]+3654602809&4294967295,_=v+(y<<4&4294967295|y>>>28),y=w+(_^v^g)+b[12]+3873151461&4294967295,w=_+(y<<11&4294967295|y>>>21),y=g+(w^_^v)+b[15]+530742520&4294967295,g=w+(y<<16&4294967295|y>>>16),y=v+(g^w^_)+b[2]+3299628645&4294967295,v=g+(y<<23&4294967295|y>>>9),y=_+(g^(v|~w))+b[0]+4096336452&4294967295,_=v+(y<<6&4294967295|y>>>26),y=w+(v^(_|~g))+b[7]+1126891415&4294967295,w=_+(y<<10&4294967295|y>>>22),y=g+(_^(w|~v))+b[14]+2878612391&4294967295,g=w+(y<<15&4294967295|y>>>17),y=v+(w^(g|~_))+b[5]+4237533241&4294967295,v=g+(y<<21&4294967295|y>>>11),y=_+(g^(v|~w))+b[12]+1700485571&4294967295,_=v+(y<<6&4294967295|y>>>26),y=w+(v^(_|~g))+b[3]+2399980690&4294967295,w=_+(y<<10&4294967295|y>>>22),y=g+(_^(w|~v))+b[10]+4293915773&4294967295,g=w+(y<<15&4294967295|y>>>17),y=v+(w^(g|~_))+b[1]+2240044497&4294967295,v=g+(y<<21&4294967295|y>>>11),y=_+(g^(v|~w))+b[8]+1873313359&4294967295,_=v+(y<<6&4294967295|y>>>26),y=w+(v^(_|~g))+b[15]+4264355552&4294967295,w=_+(y<<10&4294967295|y>>>22),y=g+(_^(w|~v))+b[6]+2734768916&4294967295,g=w+(y<<15&4294967295|y>>>17),y=v+(w^(g|~_))+b[13]+1309151649&4294967295,v=g+(y<<21&4294967295|y>>>11),y=_+(g^(v|~w))+b[4]+4149444226&4294967295,_=v+(y<<6&4294967295|y>>>26),y=w+(v^(_|~g))+b[11]+3174756917&4294967295,w=_+(y<<10&4294967295|y>>>22),y=g+(_^(w|~v))+b[2]+718787259&4294967295,g=w+(y<<15&4294967295|y>>>17),y=v+(w^(g|~_))+b[9]+3951481745&4294967295,T.g[0]=T.g[0]+_&4294967295,T.g[1]=T.g[1]+(g+(y<<21&4294967295|y>>>11))&4294967295,T.g[2]=T.g[2]+g&4294967295,T.g[3]=T.g[3]+w&4294967295}s.prototype.v=function(T,_){_===void 0&&(_=T.length);const v=_-this.blockSize,b=this.C;let g=this.h,w=0;for(;w<_;){if(g==0)for(;w<=v;)r(this,T,w),w+=this.blockSize;if(typeof T=="string"){for(;w<_;)if(b[g++]=T.charCodeAt(w++),g==this.blockSize){r(this,b),g=0;break}}else for(;w<_;)if(b[g++]=T[w++],g==this.blockSize){r(this,b),g=0;break}}this.h=g,this.o+=_},s.prototype.A=function(){var T=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);T[0]=128;for(var _=1;_<T.length-8;++_)T[_]=0;_=this.o*8;for(var v=T.length-8;v<T.length;++v)T[v]=_&255,_/=256;for(this.v(T),T=Array(16),_=0,v=0;v<4;++v)for(let b=0;b<32;b+=8)T[_++]=this.g[v]>>>b&255;return T};function o(T,_){var v=c;return Object.prototype.hasOwnProperty.call(v,T)?v[T]:v[T]=_(T)}function a(T,_){this.h=_;const v=[];let b=!0;for(let g=T.length-1;g>=0;g--){const w=T[g]|0;b&&w==_||(v[g]=w,b=!1)}this.g=v}var c={};function d(T){return-128<=T&&T<128?o(T,function(_){return new a([_|0],_<0?-1:0)}):new a([T|0],T<0?-1:0)}function h(T){if(isNaN(T)||!isFinite(T))return p;if(T<0)return x(h(-T));const _=[];let v=1;for(let b=0;T>=v;b++)_[b]=T/v|0,v*=4294967296;return new a(_,0)}function f(T,_){if(T.length==0)throw Error("number format error: empty string");if(_=_||10,_<2||36<_)throw Error("radix out of range: "+_);if(T.charAt(0)=="-")return x(f(T.substring(1),_));if(T.indexOf("-")>=0)throw Error('number format error: interior "-" character');const v=h(Math.pow(_,8));let b=p;for(let w=0;w<T.length;w+=8){var g=Math.min(8,T.length-w);const y=parseInt(T.substring(w,w+g),_);g<8?(g=h(Math.pow(_,g)),b=b.j(g).add(h(y))):(b=b.j(v),b=b.add(h(y)))}return b}var p=d(0),E=d(1),A=d(16777216);n=a.prototype,n.m=function(){if(V(this))return-x(this).m();let T=0,_=1;for(let v=0;v<this.g.length;v++){const b=this.i(v);T+=(b>=0?b:4294967296+b)*_,_*=4294967296}return T},n.toString=function(T){if(T=T||10,T<2||36<T)throw Error("radix out of range: "+T);if(R(this))return"0";if(V(this))return"-"+x(this).toString(T);const _=h(Math.pow(T,6));var v=this;let b="";for(;;){const g=$(v,_).g;v=D(v,g.j(_));let w=((v.g.length>0?v.g[0]:v.h)>>>0).toString(T);if(v=g,R(v))return w+b;for(;w.length<6;)w="0"+w;b=w+b}},n.i=function(T){return T<0?0:T<this.g.length?this.g[T]:this.h};function R(T){if(T.h!=0)return!1;for(let _=0;_<T.g.length;_++)if(T.g[_]!=0)return!1;return!0}function V(T){return T.h==-1}n.l=function(T){return T=D(this,T),V(T)?-1:R(T)?0:1};function x(T){const _=T.g.length,v=[];for(let b=0;b<_;b++)v[b]=~T.g[b];return new a(v,~T.h).add(E)}n.abs=function(){return V(this)?x(this):this},n.add=function(T){const _=Math.max(this.g.length,T.g.length),v=[];let b=0;for(let g=0;g<=_;g++){let w=b+(this.i(g)&65535)+(T.i(g)&65535),y=(w>>>16)+(this.i(g)>>>16)+(T.i(g)>>>16);b=y>>>16,w&=65535,y&=65535,v[g]=y<<16|w}return new a(v,v[v.length-1]&-2147483648?-1:0)};function D(T,_){return T.add(x(_))}n.j=function(T){if(R(this)||R(T))return p;if(V(this))return V(T)?x(this).j(x(T)):x(x(this).j(T));if(V(T))return x(this.j(x(T)));if(this.l(A)<0&&T.l(A)<0)return h(this.m()*T.m());const _=this.g.length+T.g.length,v=[];for(var b=0;b<2*_;b++)v[b]=0;for(b=0;b<this.g.length;b++)for(let g=0;g<T.g.length;g++){const w=this.i(b)>>>16,y=this.i(b)&65535,U=T.i(g)>>>16,B=T.i(g)&65535;v[2*b+2*g]+=y*B,k(v,2*b+2*g),v[2*b+2*g+1]+=w*B,k(v,2*b+2*g+1),v[2*b+2*g+1]+=y*U,k(v,2*b+2*g+1),v[2*b+2*g+2]+=w*U,k(v,2*b+2*g+2)}for(T=0;T<_;T++)v[T]=v[2*T+1]<<16|v[2*T];for(T=_;T<2*_;T++)v[T]=0;return new a(v,0)};function k(T,_){for(;(T[_]&65535)!=T[_];)T[_+1]+=T[_]>>>16,T[_]&=65535,_++}function q(T,_){this.g=T,this.h=_}function $(T,_){if(R(_))throw Error("division by zero");if(R(T))return new q(p,p);if(V(T))return _=$(x(T),_),new q(x(_.g),x(_.h));if(V(_))return _=$(T,x(_)),new q(x(_.g),_.h);if(T.g.length>30){if(V(T)||V(_))throw Error("slowDivide_ only works with positive integers.");for(var v=E,b=_;b.l(T)<=0;)v=N(v),b=N(b);var g=O(v,1),w=O(b,1);for(b=O(b,2),v=O(v,2);!R(b);){var y=w.add(b);y.l(T)<=0&&(g=g.add(v),w=y),b=O(b,1),v=O(v,1)}return _=D(T,g.j(_)),new q(g,_)}for(g=p;T.l(_)>=0;){for(v=Math.max(1,Math.floor(T.m()/_.m())),b=Math.ceil(Math.log(v)/Math.LN2),b=b<=48?1:Math.pow(2,b-48),w=h(v),y=w.j(_);V(y)||y.l(T)>0;)v-=b,w=h(v),y=w.j(_);R(w)&&(w=E),g=g.add(w),T=D(T,y)}return new q(g,T)}n.B=function(T){return $(this,T).h},n.and=function(T){const _=Math.max(this.g.length,T.g.length),v=[];for(let b=0;b<_;b++)v[b]=this.i(b)&T.i(b);return new a(v,this.h&T.h)},n.or=function(T){const _=Math.max(this.g.length,T.g.length),v=[];for(let b=0;b<_;b++)v[b]=this.i(b)|T.i(b);return new a(v,this.h|T.h)},n.xor=function(T){const _=Math.max(this.g.length,T.g.length),v=[];for(let b=0;b<_;b++)v[b]=this.i(b)^T.i(b);return new a(v,this.h^T.h)};function N(T){const _=T.g.length+1,v=[];for(let b=0;b<_;b++)v[b]=T.i(b)<<1|T.i(b-1)>>>31;return new a(v,T.h)}function O(T,_){const v=_>>5;_%=32;const b=T.g.length-v,g=[];for(let w=0;w<b;w++)g[w]=_>0?T.i(w+v)>>>_|T.i(w+v+1)<<32-_:T.i(w+v);return new a(g,T.h)}s.prototype.digest=s.prototype.A,s.prototype.reset=s.prototype.u,s.prototype.update=s.prototype.v,Jl=s,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.B,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=h,a.fromString=f,dt=a}).apply(typeof Sa<"u"?Sa:typeof self<"u"?self:typeof window<"u"?window:{});var vs=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Ql,Sn,Wl,Is,si,Kl,Yl,Xl;(function(){var n,e=Object.defineProperty;function t(i){i=[typeof globalThis=="object"&&globalThis,i,typeof window=="object"&&window,typeof self=="object"&&self,typeof vs=="object"&&vs];for(var l=0;l<i.length;++l){var u=i[l];if(u&&u.Math==Math)return u}throw Error("Cannot find global object")}var s=t(this);function r(i,l){if(l)e:{var u=s;i=i.split(".");for(var m=0;m<i.length-1;m++){var I=i[m];if(!(I in u))break e;u=u[I]}i=i[i.length-1],m=u[i],l=l(m),l!=m&&l!=null&&e(u,i,{configurable:!0,writable:!0,value:l})}}r("Symbol.dispose",function(i){return i||Symbol("Symbol.dispose")}),r("Array.prototype.values",function(i){return i||function(){return this[Symbol.iterator]()}}),r("Object.entries",function(i){return i||function(l){var u=[],m;for(m in l)Object.prototype.hasOwnProperty.call(l,m)&&u.push([m,l[m]]);return u}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},a=this||self;function c(i){var l=typeof i;return l=="object"&&i!=null||l=="function"}function d(i,l,u){return i.call.apply(i.bind,arguments)}function h(i,l,u){return h=d,h.apply(null,arguments)}function f(i,l){var u=Array.prototype.slice.call(arguments,1);return function(){var m=u.slice();return m.push.apply(m,arguments),i.apply(this,m)}}function p(i,l){function u(){}u.prototype=l.prototype,i.Z=l.prototype,i.prototype=new u,i.prototype.constructor=i,i.Ob=function(m,I,S){for(var L=Array(arguments.length-2),Q=2;Q<arguments.length;Q++)L[Q-2]=arguments[Q];return l.prototype[I].apply(m,L)}}var E=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?i=>i&&AsyncContext.Snapshot.wrap(i):i=>i;function A(i){const l=i.length;if(l>0){const u=Array(l);for(let m=0;m<l;m++)u[m]=i[m];return u}return[]}function R(i,l){for(let m=1;m<arguments.length;m++){const I=arguments[m];var u=typeof I;if(u=u!="object"?u:I?Array.isArray(I)?"array":u:"null",u=="array"||u=="object"&&typeof I.length=="number"){u=i.length||0;const S=I.length||0;i.length=u+S;for(let L=0;L<S;L++)i[u+L]=I[L]}else i.push(I)}}class V{constructor(l,u){this.i=l,this.j=u,this.h=0,this.g=null}get(){let l;return this.h>0?(this.h--,l=this.g,this.g=l.next,l.next=null):l=this.i(),l}}function x(i){a.setTimeout(()=>{throw i},0)}function D(){var i=T;let l=null;return i.g&&(l=i.g,i.g=i.g.next,i.g||(i.h=null),l.next=null),l}class k{constructor(){this.h=this.g=null}add(l,u){const m=q.get();m.set(l,u),this.h?this.h.next=m:this.g=m,this.h=m}}var q=new V(()=>new $,i=>i.reset());class ${constructor(){this.next=this.g=this.h=null}set(l,u){this.h=l,this.g=u,this.next=null}reset(){this.next=this.g=this.h=null}}let N,O=!1,T=new k,_=()=>{const i=Promise.resolve(void 0);N=()=>{i.then(v)}};function v(){for(var i;i=D();){try{i.h.call(i.g)}catch(u){x(u)}var l=q;l.j(i),l.h<100&&(l.h++,i.next=l.g,l.g=i)}O=!1}function b(){this.u=this.u,this.C=this.C}b.prototype.u=!1,b.prototype.dispose=function(){this.u||(this.u=!0,this.N())},b.prototype[Symbol.dispose]=function(){this.dispose()},b.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function g(i,l){this.type=i,this.g=this.target=l,this.defaultPrevented=!1}g.prototype.h=function(){this.defaultPrevented=!0};var w=(function(){if(!a.addEventListener||!Object.defineProperty)return!1;var i=!1,l=Object.defineProperty({},"passive",{get:function(){i=!0}});try{const u=()=>{};a.addEventListener("test",u,l),a.removeEventListener("test",u,l)}catch{}return i})();function y(i){return/^[\s\xa0]*$/.test(i)}function U(i,l){g.call(this,i?i.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,i&&this.init(i,l)}p(U,g),U.prototype.init=function(i,l){const u=this.type=i.type,m=i.changedTouches&&i.changedTouches.length?i.changedTouches[0]:null;this.target=i.target||i.srcElement,this.g=l,l=i.relatedTarget,l||(u=="mouseover"?l=i.fromElement:u=="mouseout"&&(l=i.toElement)),this.relatedTarget=l,m?(this.clientX=m.clientX!==void 0?m.clientX:m.pageX,this.clientY=m.clientY!==void 0?m.clientY:m.pageY,this.screenX=m.screenX||0,this.screenY=m.screenY||0):(this.clientX=i.clientX!==void 0?i.clientX:i.pageX,this.clientY=i.clientY!==void 0?i.clientY:i.pageY,this.screenX=i.screenX||0,this.screenY=i.screenY||0),this.button=i.button,this.key=i.key||"",this.ctrlKey=i.ctrlKey,this.altKey=i.altKey,this.shiftKey=i.shiftKey,this.metaKey=i.metaKey,this.pointerId=i.pointerId||0,this.pointerType=i.pointerType,this.state=i.state,this.i=i,i.defaultPrevented&&U.Z.h.call(this)},U.prototype.h=function(){U.Z.h.call(this);const i=this.i;i.preventDefault?i.preventDefault():i.returnValue=!1};var B="closure_listenable_"+(Math.random()*1e6|0),Y=0;function ae(i,l,u,m,I){this.listener=i,this.proxy=null,this.src=l,this.type=u,this.capture=!!m,this.ha=I,this.key=++Y,this.da=this.fa=!1}function ns(i){i.da=!0,i.listener=null,i.proxy=null,i.src=null,i.ha=null}function ss(i,l,u){for(const m in i)l.call(u,i[m],m,i)}function $u(i,l){for(const u in i)l.call(void 0,i[u],u,i)}function mo(i){const l={};for(const u in i)l[u]=i[u];return l}const po="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function go(i,l){let u,m;for(let I=1;I<arguments.length;I++){m=arguments[I];for(u in m)i[u]=m[u];for(let S=0;S<po.length;S++)u=po[S],Object.prototype.hasOwnProperty.call(m,u)&&(i[u]=m[u])}}function rs(i){this.src=i,this.g={},this.h=0}rs.prototype.add=function(i,l,u,m,I){const S=i.toString();i=this.g[S],i||(i=this.g[S]=[],this.h++);const L=pr(i,l,m,I);return L>-1?(l=i[L],u||(l.fa=!1)):(l=new ae(l,this.src,S,!!m,I),l.fa=u,i.push(l)),l};function mr(i,l){const u=l.type;if(u in i.g){var m=i.g[u],I=Array.prototype.indexOf.call(m,l,void 0),S;(S=I>=0)&&Array.prototype.splice.call(m,I,1),S&&(ns(l),i.g[u].length==0&&(delete i.g[u],i.h--))}}function pr(i,l,u,m){for(let I=0;I<i.length;++I){const S=i[I];if(!S.da&&S.listener==l&&S.capture==!!u&&S.ha==m)return I}return-1}var gr="closure_lm_"+(Math.random()*1e6|0),yr={};function yo(i,l,u,m,I){if(Array.isArray(l)){for(let S=0;S<l.length;S++)yo(i,l[S],u,m,I);return null}return u=Eo(u),i&&i[B]?i.J(l,u,c(m)?!!m.capture:!1,I):qu(i,l,u,!1,m,I)}function qu(i,l,u,m,I,S){if(!l)throw Error("Invalid event type");const L=c(I)?!!I.capture:!!I;let Q=_r(i);if(Q||(i[gr]=Q=new rs(i)),u=Q.add(l,u,m,L,S),u.proxy)return u;if(m=Bu(),u.proxy=m,m.src=i,m.listener=u,i.addEventListener)w||(I=L),I===void 0&&(I=!1),i.addEventListener(l.toString(),m,I);else if(i.attachEvent)i.attachEvent(_o(l.toString()),m);else if(i.addListener&&i.removeListener)i.addListener(m);else throw Error("addEventListener and attachEvent are unavailable.");return u}function Bu(){function i(u){return l.call(i.src,i.listener,u)}const l=Uu;return i}function vo(i,l,u,m,I){if(Array.isArray(l))for(var S=0;S<l.length;S++)vo(i,l[S],u,m,I);else m=c(m)?!!m.capture:!!m,u=Eo(u),i&&i[B]?(i=i.i,S=String(l).toString(),S in i.g&&(l=i.g[S],u=pr(l,u,m,I),u>-1&&(ns(l[u]),Array.prototype.splice.call(l,u,1),l.length==0&&(delete i.g[S],i.h--)))):i&&(i=_r(i))&&(l=i.g[l.toString()],i=-1,l&&(i=pr(l,u,m,I)),(u=i>-1?l[i]:null)&&vr(u))}function vr(i){if(typeof i!="number"&&i&&!i.da){var l=i.src;if(l&&l[B])mr(l.i,i);else{var u=i.type,m=i.proxy;l.removeEventListener?l.removeEventListener(u,m,i.capture):l.detachEvent?l.detachEvent(_o(u),m):l.addListener&&l.removeListener&&l.removeListener(m),(u=_r(l))?(mr(u,i),u.h==0&&(u.src=null,l[gr]=null)):ns(i)}}}function _o(i){return i in yr?yr[i]:yr[i]="on"+i}function Uu(i,l){if(i.da)i=!0;else{l=new U(l,this);const u=i.listener,m=i.ha||i.src;i.fa&&vr(i),i=u.call(m,l)}return i}function _r(i){return i=i[gr],i instanceof rs?i:null}var Er="__closure_events_fn_"+(Math.random()*1e9>>>0);function Eo(i){return typeof i=="function"?i:(i[Er]||(i[Er]=function(l){return i.handleEvent(l)}),i[Er])}function Te(){b.call(this),this.i=new rs(this),this.M=this,this.G=null}p(Te,b),Te.prototype[B]=!0,Te.prototype.removeEventListener=function(i,l,u,m){vo(this,i,l,u,m)};function Ce(i,l){var u,m=i.G;if(m)for(u=[];m;m=m.G)u.push(m);if(i=i.M,m=l.type||l,typeof l=="string")l=new g(l,i);else if(l instanceof g)l.target=l.target||i;else{var I=l;l=new g(m,i),go(l,I)}I=!0;let S,L;if(u)for(L=u.length-1;L>=0;L--)S=l.g=u[L],I=is(S,m,!0,l)&&I;if(S=l.g=i,I=is(S,m,!0,l)&&I,I=is(S,m,!1,l)&&I,u)for(L=0;L<u.length;L++)S=l.g=u[L],I=is(S,m,!1,l)&&I}Te.prototype.N=function(){if(Te.Z.N.call(this),this.i){var i=this.i;for(const l in i.g){const u=i.g[l];for(let m=0;m<u.length;m++)ns(u[m]);delete i.g[l],i.h--}}this.G=null},Te.prototype.J=function(i,l,u,m){return this.i.add(String(i),l,!1,u,m)},Te.prototype.K=function(i,l,u,m){return this.i.add(String(i),l,!0,u,m)};function is(i,l,u,m){if(l=i.i.g[String(l)],!l)return!0;l=l.concat();let I=!0;for(let S=0;S<l.length;++S){const L=l[S];if(L&&!L.da&&L.capture==u){const Q=L.listener,pe=L.ha||L.src;L.fa&&mr(i.i,L),I=Q.call(pe,m)!==!1&&I}}return I&&!m.defaultPrevented}function ju(i,l){if(typeof i!="function")if(i&&typeof i.handleEvent=="function")i=h(i.handleEvent,i);else throw Error("Invalid listener argument");return Number(l)>2147483647?-1:a.setTimeout(i,l||0)}function bo(i){i.g=ju(()=>{i.g=null,i.i&&(i.i=!1,bo(i))},i.l);const l=i.h;i.h=null,i.m.apply(null,l)}class zu extends b{constructor(l,u){super(),this.m=l,this.l=u,this.h=null,this.i=!1,this.g=null}j(l){this.h=arguments,this.g?this.i=!0:bo(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function cn(i){b.call(this),this.h=i,this.g={}}p(cn,b);var To=[];function wo(i){ss(i.g,function(l,u){this.g.hasOwnProperty(u)&&vr(l)},i),i.g={}}cn.prototype.N=function(){cn.Z.N.call(this),wo(this)},cn.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var br=a.JSON.stringify,Gu=a.JSON.parse,Hu=class{stringify(i){return a.JSON.stringify(i,void 0)}parse(i){return a.JSON.parse(i,void 0)}};function Io(){}function Ao(){}var un={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Tr(){g.call(this,"d")}p(Tr,g);function wr(){g.call(this,"c")}p(wr,g);var wt={},So=null;function os(){return So=So||new Te}wt.Ia="serverreachability";function Ro(i){g.call(this,wt.Ia,i)}p(Ro,g);function dn(i){const l=os();Ce(l,new Ro(l))}wt.STAT_EVENT="statevent";function Co(i,l){g.call(this,wt.STAT_EVENT,i),this.stat=l}p(Co,g);function Pe(i){const l=os();Ce(l,new Co(l,i))}wt.Ja="timingevent";function Po(i,l){g.call(this,wt.Ja,i),this.size=l}p(Po,g);function hn(i,l){if(typeof i!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){i()},l)}function fn(){this.g=!0}fn.prototype.ua=function(){this.g=!1};function Ju(i,l,u,m,I,S){i.info(function(){if(i.g)if(S){var L="",Q=S.split("&");for(let ne=0;ne<Q.length;ne++){var pe=Q[ne].split("=");if(pe.length>1){const ye=pe[0];pe=pe[1];const Ue=ye.split("_");L=Ue.length>=2&&Ue[1]=="type"?L+(ye+"="+pe+"&"):L+(ye+"=redacted&")}}}else L=null;else L=S;return"XMLHTTP REQ ("+m+") [attempt "+I+"]: "+l+`
`+u+`
`+L})}function Qu(i,l,u,m,I,S,L){i.info(function(){return"XMLHTTP RESP ("+m+") [ attempt "+I+"]: "+l+`
`+u+`
`+S+" "+L})}function qt(i,l,u,m){i.info(function(){return"XMLHTTP TEXT ("+l+"): "+Ku(i,u)+(m?" "+m:"")})}function Wu(i,l){i.info(function(){return"TIMEOUT: "+l})}fn.prototype.info=function(){};function Ku(i,l){if(!i.g)return l;if(!l)return null;try{const S=JSON.parse(l);if(S){for(i=0;i<S.length;i++)if(Array.isArray(S[i])){var u=S[i];if(!(u.length<2)){var m=u[1];if(Array.isArray(m)&&!(m.length<1)){var I=m[0];if(I!="noop"&&I!="stop"&&I!="close")for(let L=1;L<m.length;L++)m[L]=""}}}}return br(S)}catch{return l}}var as={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},Do={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},Vo;function Ir(){}p(Ir,Io),Ir.prototype.g=function(){return new XMLHttpRequest},Vo=new Ir;function mn(i){return encodeURIComponent(String(i))}function Yu(i){var l=1;i=i.split(":");const u=[];for(;l>0&&i.length;)u.push(i.shift()),l--;return i.length&&u.push(i.join(":")),u}function nt(i,l,u,m){this.j=i,this.i=l,this.l=u,this.S=m||1,this.V=new cn(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new xo}function xo(){this.i=null,this.g="",this.h=!1}var No={},Ar={};function Sr(i,l,u){i.M=1,i.A=cs(Be(l)),i.u=u,i.R=!0,ko(i,null)}function ko(i,l){i.F=Date.now(),ls(i),i.B=Be(i.A);var u=i.B,m=i.S;Array.isArray(m)||(m=[String(m)]),Jo(u.i,"t",m),i.C=0,u=i.j.L,i.h=new xo,i.g=da(i.j,u?l:null,!i.u),i.P>0&&(i.O=new zu(h(i.Y,i,i.g),i.P)),l=i.V,u=i.g,m=i.ba;var I="readystatechange";Array.isArray(I)||(I&&(To[0]=I.toString()),I=To);for(let S=0;S<I.length;S++){const L=yo(u,I[S],m||l.handleEvent,!1,l.h||l);if(!L)break;l.g[L.key]=L}l=i.J?mo(i.J):{},i.u?(i.v||(i.v="POST"),l["Content-Type"]="application/x-www-form-urlencoded",i.g.ea(i.B,i.v,i.u,l)):(i.v="GET",i.g.ea(i.B,i.v,null,l)),dn(),Ju(i.i,i.v,i.B,i.l,i.S,i.u)}nt.prototype.ba=function(i){i=i.target;const l=this.O;l&&it(i)==3?l.j():this.Y(i)},nt.prototype.Y=function(i){try{if(i==this.g)e:{const Q=it(this.g),pe=this.g.ya(),ne=this.g.ca();if(!(Q<3)&&(Q!=3||this.g&&(this.h.h||this.g.la()||ea(this.g)))){this.K||Q!=4||pe==7||(pe==8||ne<=0?dn(3):dn(2)),Rr(this);var l=this.g.ca();this.X=l;var u=Xu(this);if(this.o=l==200,Qu(this.i,this.v,this.B,this.l,this.S,Q,l),this.o){if(this.U&&!this.L){t:{if(this.g){var m,I=this.g;if((m=I.g?I.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!y(m)){var S=m;break t}}S=null}if(i=S)qt(this.i,this.l,i,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Cr(this,i);else{this.o=!1,this.m=3,Pe(12),It(this),pn(this);break e}}if(this.R){i=!0;let ye;for(;!this.K&&this.C<u.length;)if(ye=Zu(this,u),ye==Ar){Q==4&&(this.m=4,Pe(14),i=!1),qt(this.i,this.l,null,"[Incomplete Response]");break}else if(ye==No){this.m=4,Pe(15),qt(this.i,this.l,u,"[Invalid Chunk]"),i=!1;break}else qt(this.i,this.l,ye,null),Cr(this,ye);if(Lo(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Q!=4||u.length!=0||this.h.h||(this.m=1,Pe(16),i=!1),this.o=this.o&&i,!i)qt(this.i,this.l,u,"[Invalid Chunked Response]"),It(this),pn(this);else if(u.length>0&&!this.W){this.W=!0;var L=this.j;L.g==this&&L.aa&&!L.P&&(L.j.info("Great, no buffering proxy detected. Bytes received: "+u.length),Mr(L),L.P=!0,Pe(11))}}else qt(this.i,this.l,u,null),Cr(this,u);Q==4&&It(this),this.o&&!this.K&&(Q==4?aa(this.j,this):(this.o=!1,ls(this)))}else fd(this.g),l==400&&u.indexOf("Unknown SID")>0?(this.m=3,Pe(12)):(this.m=0,Pe(13)),It(this),pn(this)}}}catch{}finally{}};function Xu(i){if(!Lo(i))return i.g.la();const l=ea(i.g);if(l==="")return"";let u="";const m=l.length,I=it(i.g)==4;if(!i.h.i){if(typeof TextDecoder>"u")return It(i),pn(i),"";i.h.i=new a.TextDecoder}for(let S=0;S<m;S++)i.h.h=!0,u+=i.h.i.decode(l[S],{stream:!(I&&S==m-1)});return l.length=0,i.h.g+=u,i.C=0,i.h.g}function Lo(i){return i.g?i.v=="GET"&&i.M!=2&&i.j.Aa:!1}function Zu(i,l){var u=i.C,m=l.indexOf(`
`,u);return m==-1?Ar:(u=Number(l.substring(u,m)),isNaN(u)?No:(m+=1,m+u>l.length?Ar:(l=l.slice(m,m+u),i.C=m+u,l)))}nt.prototype.cancel=function(){this.K=!0,It(this)};function ls(i){i.T=Date.now()+i.H,Mo(i,i.H)}function Mo(i,l){if(i.D!=null)throw Error("WatchDog timer not null");i.D=hn(h(i.aa,i),l)}function Rr(i){i.D&&(a.clearTimeout(i.D),i.D=null)}nt.prototype.aa=function(){this.D=null;const i=Date.now();i-this.T>=0?(Wu(this.i,this.B),this.M!=2&&(dn(),Pe(17)),It(this),this.m=2,pn(this)):Mo(this,this.T-i)};function pn(i){i.j.I==0||i.K||aa(i.j,i)}function It(i){Rr(i);var l=i.O;l&&typeof l.dispose=="function"&&l.dispose(),i.O=null,wo(i.V),i.g&&(l=i.g,i.g=null,l.abort(),l.dispose())}function Cr(i,l){try{var u=i.j;if(u.I!=0&&(u.g==i||Pr(u.h,i))){if(!i.L&&Pr(u.h,i)&&u.I==3){try{var m=u.Ba.g.parse(l)}catch{m=null}if(Array.isArray(m)&&m.length==3){var I=m;if(I[0]==0){e:if(!u.v){if(u.g)if(u.g.F+3e3<i.F)ms(u),hs(u);else break e;Lr(u),Pe(18)}}else u.xa=I[1],0<u.xa-u.K&&I[2]<37500&&u.F&&u.A==0&&!u.C&&(u.C=hn(h(u.Va,u),6e3));$o(u.h)<=1&&u.ta&&(u.ta=void 0)}else St(u,11)}else if((i.L||u.g==i)&&ms(u),!y(l))for(I=u.Ba.g.parse(l),l=0;l<I.length;l++){let ne=I[l];const ye=ne[0];if(!(ye<=u.K))if(u.K=ye,ne=ne[1],u.I==2)if(ne[0]=="c"){u.M=ne[1],u.ba=ne[2];const Ue=ne[3];Ue!=null&&(u.ka=Ue,u.j.info("VER="+u.ka));const Rt=ne[4];Rt!=null&&(u.za=Rt,u.j.info("SVER="+u.za));const ot=ne[5];ot!=null&&typeof ot=="number"&&ot>0&&(m=1.5*ot,u.O=m,u.j.info("backChannelRequestTimeoutMs_="+m)),m=u;const at=i.g;if(at){const gs=at.g?at.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(gs){var S=m.h;S.g||gs.indexOf("spdy")==-1&&gs.indexOf("quic")==-1&&gs.indexOf("h2")==-1||(S.j=S.l,S.g=new Set,S.h&&(Dr(S,S.h),S.h=null))}if(m.G){const Or=at.g?at.g.getResponseHeader("X-HTTP-Session-Id"):null;Or&&(m.wa=Or,re(m.J,m.G,Or))}}u.I=3,u.l&&u.l.ra(),u.aa&&(u.T=Date.now()-i.F,u.j.info("Handshake RTT: "+u.T+"ms")),m=u;var L=i;if(m.na=ua(m,m.L?m.ba:null,m.W),L.L){qo(m.h,L);var Q=L,pe=m.O;pe&&(Q.H=pe),Q.D&&(Rr(Q),ls(Q)),m.g=L}else ia(m);u.i.length>0&&fs(u)}else ne[0]!="stop"&&ne[0]!="close"||St(u,7);else u.I==3&&(ne[0]=="stop"||ne[0]=="close"?ne[0]=="stop"?St(u,7):kr(u):ne[0]!="noop"&&u.l&&u.l.qa(ne),u.A=0)}}dn(4)}catch{}}var ed=class{constructor(i,l){this.g=i,this.map=l}};function Oo(i){this.l=i||10,a.PerformanceNavigationTiming?(i=a.performance.getEntriesByType("navigation"),i=i.length>0&&(i[0].nextHopProtocol=="hq"||i[0].nextHopProtocol=="h2")):i=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=i?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function Fo(i){return i.h?!0:i.g?i.g.size>=i.j:!1}function $o(i){return i.h?1:i.g?i.g.size:0}function Pr(i,l){return i.h?i.h==l:i.g?i.g.has(l):!1}function Dr(i,l){i.g?i.g.add(l):i.h=l}function qo(i,l){i.h&&i.h==l?i.h=null:i.g&&i.g.has(l)&&i.g.delete(l)}Oo.prototype.cancel=function(){if(this.i=Bo(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const i of this.g.values())i.cancel();this.g.clear()}};function Bo(i){if(i.h!=null)return i.i.concat(i.h.G);if(i.g!=null&&i.g.size!==0){let l=i.i;for(const u of i.g.values())l=l.concat(u.G);return l}return A(i.i)}var Uo=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function td(i,l){if(i){i=i.split("&");for(let u=0;u<i.length;u++){const m=i[u].indexOf("=");let I,S=null;m>=0?(I=i[u].substring(0,m),S=i[u].substring(m+1)):I=i[u],l(I,S?decodeURIComponent(S.replace(/\+/g," ")):"")}}}function st(i){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let l;i instanceof st?(this.l=i.l,gn(this,i.j),this.o=i.o,this.g=i.g,yn(this,i.u),this.h=i.h,Vr(this,Qo(i.i)),this.m=i.m):i&&(l=String(i).match(Uo))?(this.l=!1,gn(this,l[1]||"",!0),this.o=vn(l[2]||""),this.g=vn(l[3]||"",!0),yn(this,l[4]),this.h=vn(l[5]||"",!0),Vr(this,l[6]||"",!0),this.m=vn(l[7]||"")):(this.l=!1,this.i=new En(null,this.l))}st.prototype.toString=function(){const i=[];var l=this.j;l&&i.push(_n(l,jo,!0),":");var u=this.g;return(u||l=="file")&&(i.push("//"),(l=this.o)&&i.push(_n(l,jo,!0),"@"),i.push(mn(u).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),u=this.u,u!=null&&i.push(":",String(u))),(u=this.h)&&(this.g&&u.charAt(0)!="/"&&i.push("/"),i.push(_n(u,u.charAt(0)=="/"?rd:sd,!0))),(u=this.i.toString())&&i.push("?",u),(u=this.m)&&i.push("#",_n(u,od)),i.join("")},st.prototype.resolve=function(i){const l=Be(this);let u=!!i.j;u?gn(l,i.j):u=!!i.o,u?l.o=i.o:u=!!i.g,u?l.g=i.g:u=i.u!=null;var m=i.h;if(u)yn(l,i.u);else if(u=!!i.h){if(m.charAt(0)!="/")if(this.g&&!this.h)m="/"+m;else{var I=l.h.lastIndexOf("/");I!=-1&&(m=l.h.slice(0,I+1)+m)}if(I=m,I==".."||I==".")m="";else if(I.indexOf("./")!=-1||I.indexOf("/.")!=-1){m=I.lastIndexOf("/",0)==0,I=I.split("/");const S=[];for(let L=0;L<I.length;){const Q=I[L++];Q=="."?m&&L==I.length&&S.push(""):Q==".."?((S.length>1||S.length==1&&S[0]!="")&&S.pop(),m&&L==I.length&&S.push("")):(S.push(Q),m=!0)}m=S.join("/")}else m=I}return u?l.h=m:u=i.i.toString()!=="",u?Vr(l,Qo(i.i)):u=!!i.m,u&&(l.m=i.m),l};function Be(i){return new st(i)}function gn(i,l,u){i.j=u?vn(l,!0):l,i.j&&(i.j=i.j.replace(/:$/,""))}function yn(i,l){if(l){if(l=Number(l),isNaN(l)||l<0)throw Error("Bad port number "+l);i.u=l}else i.u=null}function Vr(i,l,u){l instanceof En?(i.i=l,ad(i.i,i.l)):(u||(l=_n(l,id)),i.i=new En(l,i.l))}function re(i,l,u){i.i.set(l,u)}function cs(i){return re(i,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),i}function vn(i,l){return i?l?decodeURI(i.replace(/%25/g,"%2525")):decodeURIComponent(i):""}function _n(i,l,u){return typeof i=="string"?(i=encodeURI(i).replace(l,nd),u&&(i=i.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),i):null}function nd(i){return i=i.charCodeAt(0),"%"+(i>>4&15).toString(16)+(i&15).toString(16)}var jo=/[#\/\?@]/g,sd=/[#\?:]/g,rd=/[#\?]/g,id=/[#\?@]/g,od=/#/g;function En(i,l){this.h=this.g=null,this.i=i||null,this.j=!!l}function At(i){i.g||(i.g=new Map,i.h=0,i.i&&td(i.i,function(l,u){i.add(decodeURIComponent(l.replace(/\+/g," ")),u)}))}n=En.prototype,n.add=function(i,l){At(this),this.i=null,i=Bt(this,i);let u=this.g.get(i);return u||this.g.set(i,u=[]),u.push(l),this.h+=1,this};function zo(i,l){At(i),l=Bt(i,l),i.g.has(l)&&(i.i=null,i.h-=i.g.get(l).length,i.g.delete(l))}function Go(i,l){return At(i),l=Bt(i,l),i.g.has(l)}n.forEach=function(i,l){At(this),this.g.forEach(function(u,m){u.forEach(function(I){i.call(l,I,m,this)},this)},this)};function Ho(i,l){At(i);let u=[];if(typeof l=="string")Go(i,l)&&(u=u.concat(i.g.get(Bt(i,l))));else for(i=Array.from(i.g.values()),l=0;l<i.length;l++)u=u.concat(i[l]);return u}n.set=function(i,l){return At(this),this.i=null,i=Bt(this,i),Go(this,i)&&(this.h-=this.g.get(i).length),this.g.set(i,[l]),this.h+=1,this},n.get=function(i,l){return i?(i=Ho(this,i),i.length>0?String(i[0]):l):l};function Jo(i,l,u){zo(i,l),u.length>0&&(i.i=null,i.g.set(Bt(i,l),A(u)),i.h+=u.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const i=[],l=Array.from(this.g.keys());for(let m=0;m<l.length;m++){var u=l[m];const I=mn(u);u=Ho(this,u);for(let S=0;S<u.length;S++){let L=I;u[S]!==""&&(L+="="+mn(u[S])),i.push(L)}}return this.i=i.join("&")};function Qo(i){const l=new En;return l.i=i.i,i.g&&(l.g=new Map(i.g),l.h=i.h),l}function Bt(i,l){return l=String(l),i.j&&(l=l.toLowerCase()),l}function ad(i,l){l&&!i.j&&(At(i),i.i=null,i.g.forEach(function(u,m){const I=m.toLowerCase();m!=I&&(zo(this,m),Jo(this,I,u))},i)),i.j=l}function ld(i,l){const u=new fn;if(a.Image){const m=new Image;m.onload=f(rt,u,"TestLoadImage: loaded",!0,l,m),m.onerror=f(rt,u,"TestLoadImage: error",!1,l,m),m.onabort=f(rt,u,"TestLoadImage: abort",!1,l,m),m.ontimeout=f(rt,u,"TestLoadImage: timeout",!1,l,m),a.setTimeout(function(){m.ontimeout&&m.ontimeout()},1e4),m.src=i}else l(!1)}function cd(i,l){const u=new fn,m=new AbortController,I=setTimeout(()=>{m.abort(),rt(u,"TestPingServer: timeout",!1,l)},1e4);fetch(i,{signal:m.signal}).then(S=>{clearTimeout(I),S.ok?rt(u,"TestPingServer: ok",!0,l):rt(u,"TestPingServer: server error",!1,l)}).catch(()=>{clearTimeout(I),rt(u,"TestPingServer: error",!1,l)})}function rt(i,l,u,m,I){try{I&&(I.onload=null,I.onerror=null,I.onabort=null,I.ontimeout=null),m(u)}catch{}}function ud(){this.g=new Hu}function xr(i){this.i=i.Sb||null,this.h=i.ab||!1}p(xr,Io),xr.prototype.g=function(){return new us(this.i,this.h)};function us(i,l){Te.call(this),this.H=i,this.o=l,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}p(us,Te),n=us.prototype,n.open=function(i,l){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=i,this.D=l,this.readyState=1,Tn(this)},n.send=function(i){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const l={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};i&&(l.body=i),(this.H||a).fetch(new Request(this.D,l)).then(this.Pa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,bn(this)),this.readyState=0},n.Pa=function(i){if(this.g&&(this.l=i,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=i.headers,this.readyState=2,Tn(this)),this.g&&(this.readyState=3,Tn(this),this.g)))if(this.responseType==="arraybuffer")i.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in i){if(this.j=i.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;Wo(this)}else i.text().then(this.Oa.bind(this),this.ga.bind(this))};function Wo(i){i.j.read().then(i.Ma.bind(i)).catch(i.ga.bind(i))}n.Ma=function(i){if(this.g){if(this.o&&i.value)this.response.push(i.value);else if(!this.o){var l=i.value?i.value:new Uint8Array(0);(l=this.B.decode(l,{stream:!i.done}))&&(this.response=this.responseText+=l)}i.done?bn(this):Tn(this),this.readyState==3&&Wo(this)}},n.Oa=function(i){this.g&&(this.response=this.responseText=i,bn(this))},n.Na=function(i){this.g&&(this.response=i,bn(this))},n.ga=function(){this.g&&bn(this)};function bn(i){i.readyState=4,i.l=null,i.j=null,i.B=null,Tn(i)}n.setRequestHeader=function(i,l){this.A.append(i,l)},n.getResponseHeader=function(i){return this.h&&this.h.get(i.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const i=[],l=this.h.entries();for(var u=l.next();!u.done;)u=u.value,i.push(u[0]+": "+u[1]),u=l.next();return i.join(`\r
`)};function Tn(i){i.onreadystatechange&&i.onreadystatechange.call(i)}Object.defineProperty(us.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(i){this.m=i?"include":"same-origin"}});function Ko(i){let l="";return ss(i,function(u,m){l+=m,l+=":",l+=u,l+=`\r
`}),l}function Nr(i,l,u){e:{for(m in u){var m=!1;break e}m=!0}m||(u=Ko(u),typeof i=="string"?u!=null&&mn(u):re(i,l,u))}function le(i){Te.call(this),this.headers=new Map,this.L=i||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}p(le,Te);var dd=/^https?$/i,hd=["POST","PUT"];n=le.prototype,n.Fa=function(i){this.H=i},n.ea=function(i,l,u,m){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+i);l=l?l.toUpperCase():"GET",this.D=i,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():Vo.g(),this.g.onreadystatechange=E(h(this.Ca,this));try{this.B=!0,this.g.open(l,String(i),!0),this.B=!1}catch(S){Yo(this,S);return}if(i=u||"",u=new Map(this.headers),m)if(Object.getPrototypeOf(m)===Object.prototype)for(var I in m)u.set(I,m[I]);else if(typeof m.keys=="function"&&typeof m.get=="function")for(const S of m.keys())u.set(S,m.get(S));else throw Error("Unknown input type for opt_headers: "+String(m));m=Array.from(u.keys()).find(S=>S.toLowerCase()=="content-type"),I=a.FormData&&i instanceof a.FormData,!(Array.prototype.indexOf.call(hd,l,void 0)>=0)||m||I||u.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[S,L]of u)this.g.setRequestHeader(S,L);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(i),this.v=!1}catch(S){Yo(this,S)}};function Yo(i,l){i.h=!1,i.g&&(i.j=!0,i.g.abort(),i.j=!1),i.l=l,i.o=5,Xo(i),ds(i)}function Xo(i){i.A||(i.A=!0,Ce(i,"complete"),Ce(i,"error"))}n.abort=function(i){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=i||7,Ce(this,"complete"),Ce(this,"abort"),ds(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),ds(this,!0)),le.Z.N.call(this)},n.Ca=function(){this.u||(this.B||this.v||this.j?Zo(this):this.Xa())},n.Xa=function(){Zo(this)};function Zo(i){if(i.h&&typeof o<"u"){if(i.v&&it(i)==4)setTimeout(i.Ca.bind(i),0);else if(Ce(i,"readystatechange"),it(i)==4){i.h=!1;try{const S=i.ca();e:switch(S){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var l=!0;break e;default:l=!1}var u;if(!(u=l)){var m;if(m=S===0){let L=String(i.D).match(Uo)[1]||null;!L&&a.self&&a.self.location&&(L=a.self.location.protocol.slice(0,-1)),m=!dd.test(L?L.toLowerCase():"")}u=m}if(u)Ce(i,"complete"),Ce(i,"success");else{i.o=6;try{var I=it(i)>2?i.g.statusText:""}catch{I=""}i.l=I+" ["+i.ca()+"]",Xo(i)}}finally{ds(i)}}}}function ds(i,l){if(i.g){i.m&&(clearTimeout(i.m),i.m=null);const u=i.g;i.g=null,l||Ce(i,"ready");try{u.onreadystatechange=null}catch{}}}n.isActive=function(){return!!this.g};function it(i){return i.g?i.g.readyState:0}n.ca=function(){try{return it(this)>2?this.g.status:-1}catch{return-1}},n.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.La=function(i){if(this.g){var l=this.g.responseText;return i&&l.indexOf(i)==0&&(l=l.substring(i.length)),Gu(l)}};function ea(i){try{if(!i.g)return null;if("response"in i.g)return i.g.response;switch(i.F){case"":case"text":return i.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in i.g)return i.g.mozResponseArrayBuffer}return null}catch{return null}}function fd(i){const l={};i=(i.g&&it(i)>=2&&i.g.getAllResponseHeaders()||"").split(`\r
`);for(let m=0;m<i.length;m++){if(y(i[m]))continue;var u=Yu(i[m]);const I=u[0];if(u=u[1],typeof u!="string")continue;u=u.trim();const S=l[I]||[];l[I]=S,S.push(u)}$u(l,function(m){return m.join(", ")})}n.ya=function(){return this.o},n.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function wn(i,l,u){return u&&u.internalChannelParams&&u.internalChannelParams[i]||l}function ta(i){this.za=0,this.i=[],this.j=new fn,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=wn("failFast",!1,i),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=wn("baseRetryDelayMs",5e3,i),this.Za=wn("retryDelaySeedMs",1e4,i),this.Ta=wn("forwardChannelMaxRetries",2,i),this.va=wn("forwardChannelRequestTimeoutMs",2e4,i),this.ma=i&&i.xmlHttpFactory||void 0,this.Ua=i&&i.Rb||void 0,this.Aa=i&&i.useFetchStreams||!1,this.O=void 0,this.L=i&&i.supportsCrossDomainXhr||!1,this.M="",this.h=new Oo(i&&i.concurrentRequestLimit),this.Ba=new ud,this.S=i&&i.fastHandshake||!1,this.R=i&&i.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=i&&i.Pb||!1,i&&i.ua&&this.j.ua(),i&&i.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&i&&i.detectBufferingProxy||!1,this.ia=void 0,i&&i.longPollingTimeout&&i.longPollingTimeout>0&&(this.ia=i.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}n=ta.prototype,n.ka=8,n.I=1,n.connect=function(i,l,u,m){Pe(0),this.W=i,this.H=l||{},u&&m!==void 0&&(this.H.OSID=u,this.H.OAID=m),this.F=this.X,this.J=ua(this,null,this.W),fs(this)};function kr(i){if(na(i),i.I==3){var l=i.V++,u=Be(i.J);if(re(u,"SID",i.M),re(u,"RID",l),re(u,"TYPE","terminate"),In(i,u),l=new nt(i,i.j,l),l.M=2,l.A=cs(Be(u)),u=!1,a.navigator&&a.navigator.sendBeacon)try{u=a.navigator.sendBeacon(l.A.toString(),"")}catch{}!u&&a.Image&&(new Image().src=l.A,u=!0),u||(l.g=da(l.j,null),l.g.ea(l.A)),l.F=Date.now(),ls(l)}ca(i)}function hs(i){i.g&&(Mr(i),i.g.cancel(),i.g=null)}function na(i){hs(i),i.v&&(a.clearTimeout(i.v),i.v=null),ms(i),i.h.cancel(),i.m&&(typeof i.m=="number"&&a.clearTimeout(i.m),i.m=null)}function fs(i){if(!Fo(i.h)&&!i.m){i.m=!0;var l=i.Ea;N||_(),O||(N(),O=!0),T.add(l,i),i.D=0}}function md(i,l){return $o(i.h)>=i.h.j-(i.m?1:0)?!1:i.m?(i.i=l.G.concat(i.i),!0):i.I==1||i.I==2||i.D>=(i.Sa?0:i.Ta)?!1:(i.m=hn(h(i.Ea,i,l),la(i,i.D)),i.D++,!0)}n.Ea=function(i){if(this.m)if(this.m=null,this.I==1){if(!i){this.V=Math.floor(Math.random()*1e5),i=this.V++;const I=new nt(this,this.j,i);let S=this.o;if(this.U&&(S?(S=mo(S),go(S,this.U)):S=this.U),this.u!==null||this.R||(I.J=S,S=null),this.S)e:{for(var l=0,u=0;u<this.i.length;u++){t:{var m=this.i[u];if("__data__"in m.map&&(m=m.map.__data__,typeof m=="string")){m=m.length;break t}m=void 0}if(m===void 0)break;if(l+=m,l>4096){l=u;break e}if(l===4096||u===this.i.length-1){l=u+1;break e}}l=1e3}else l=1e3;l=ra(this,I,l),u=Be(this.J),re(u,"RID",i),re(u,"CVER",22),this.G&&re(u,"X-HTTP-Session-Id",this.G),In(this,u),S&&(this.R?l="headers="+mn(Ko(S))+"&"+l:this.u&&Nr(u,this.u,S)),Dr(this.h,I),this.Ra&&re(u,"TYPE","init"),this.S?(re(u,"$req",l),re(u,"SID","null"),I.U=!0,Sr(I,u,null)):Sr(I,u,l),this.I=2}}else this.I==3&&(i?sa(this,i):this.i.length==0||Fo(this.h)||sa(this))};function sa(i,l){var u;l?u=l.l:u=i.V++;const m=Be(i.J);re(m,"SID",i.M),re(m,"RID",u),re(m,"AID",i.K),In(i,m),i.u&&i.o&&Nr(m,i.u,i.o),u=new nt(i,i.j,u,i.D+1),i.u===null&&(u.J=i.o),l&&(i.i=l.G.concat(i.i)),l=ra(i,u,1e3),u.H=Math.round(i.va*.5)+Math.round(i.va*.5*Math.random()),Dr(i.h,u),Sr(u,m,l)}function In(i,l){i.H&&ss(i.H,function(u,m){re(l,m,u)}),i.l&&ss({},function(u,m){re(l,m,u)})}function ra(i,l,u){u=Math.min(i.i.length,u);const m=i.l?h(i.l.Ka,i.l,i):null;e:{var I=i.i;let Q=-1;for(;;){const pe=["count="+u];Q==-1?u>0?(Q=I[0].g,pe.push("ofs="+Q)):Q=0:pe.push("ofs="+Q);let ne=!0;for(let ye=0;ye<u;ye++){var S=I[ye].g;const Ue=I[ye].map;if(S-=Q,S<0)Q=Math.max(0,I[ye].g-100),ne=!1;else try{S="req"+S+"_"||"";try{var L=Ue instanceof Map?Ue:Object.entries(Ue);for(const[Rt,ot]of L){let at=ot;c(ot)&&(at=br(ot)),pe.push(S+Rt+"="+encodeURIComponent(at))}}catch(Rt){throw pe.push(S+"type="+encodeURIComponent("_badmap")),Rt}}catch{m&&m(Ue)}}if(ne){L=pe.join("&");break e}}L=void 0}return i=i.i.splice(0,u),l.G=i,L}function ia(i){if(!i.g&&!i.v){i.Y=1;var l=i.Da;N||_(),O||(N(),O=!0),T.add(l,i),i.A=0}}function Lr(i){return i.g||i.v||i.A>=3?!1:(i.Y++,i.v=hn(h(i.Da,i),la(i,i.A)),i.A++,!0)}n.Da=function(){if(this.v=null,oa(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var i=4*this.T;this.j.info("BP detection timer enabled: "+i),this.B=hn(h(this.Wa,this),i)}},n.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,Pe(10),hs(this),oa(this))};function Mr(i){i.B!=null&&(a.clearTimeout(i.B),i.B=null)}function oa(i){i.g=new nt(i,i.j,"rpc",i.Y),i.u===null&&(i.g.J=i.o),i.g.P=0;var l=Be(i.na);re(l,"RID","rpc"),re(l,"SID",i.M),re(l,"AID",i.K),re(l,"CI",i.F?"0":"1"),!i.F&&i.ia&&re(l,"TO",i.ia),re(l,"TYPE","xmlhttp"),In(i,l),i.u&&i.o&&Nr(l,i.u,i.o),i.O&&(i.g.H=i.O);var u=i.g;i=i.ba,u.M=1,u.A=cs(Be(l)),u.u=null,u.R=!0,ko(u,i)}n.Va=function(){this.C!=null&&(this.C=null,hs(this),Lr(this),Pe(19))};function ms(i){i.C!=null&&(a.clearTimeout(i.C),i.C=null)}function aa(i,l){var u=null;if(i.g==l){ms(i),Mr(i),i.g=null;var m=2}else if(Pr(i.h,l))u=l.G,qo(i.h,l),m=1;else return;if(i.I!=0){if(l.o)if(m==1){u=l.u?l.u.length:0,l=Date.now()-l.F;var I=i.D;m=os(),Ce(m,new Po(m,u)),fs(i)}else ia(i);else if(I=l.m,I==3||I==0&&l.X>0||!(m==1&&md(i,l)||m==2&&Lr(i)))switch(u&&u.length>0&&(l=i.h,l.i=l.i.concat(u)),I){case 1:St(i,5);break;case 4:St(i,10);break;case 3:St(i,6);break;default:St(i,2)}}}function la(i,l){let u=i.Qa+Math.floor(Math.random()*i.Za);return i.isActive()||(u*=2),u*l}function St(i,l){if(i.j.info("Error code "+l),l==2){var u=h(i.bb,i),m=i.Ua;const I=!m;m=new st(m||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||gn(m,"https"),cs(m),I?ld(m.toString(),u):cd(m.toString(),u)}else Pe(2);i.I=0,i.l&&i.l.pa(l),ca(i),na(i)}n.bb=function(i){i?(this.j.info("Successfully pinged google.com"),Pe(2)):(this.j.info("Failed to ping google.com"),Pe(1))};function ca(i){if(i.I=0,i.ja=[],i.l){const l=Bo(i.h);(l.length!=0||i.i.length!=0)&&(R(i.ja,l),R(i.ja,i.i),i.h.i.length=0,A(i.i),i.i.length=0),i.l.oa()}}function ua(i,l,u){var m=u instanceof st?Be(u):new st(u);if(m.g!="")l&&(m.g=l+"."+m.g),yn(m,m.u);else{var I=a.location;m=I.protocol,l=l?l+"."+I.hostname:I.hostname,I=+I.port;const S=new st(null);m&&gn(S,m),l&&(S.g=l),I&&yn(S,I),u&&(S.h=u),m=S}return u=i.G,l=i.wa,u&&l&&re(m,u,l),re(m,"VER",i.ka),In(i,m),m}function da(i,l,u){if(l&&!i.L)throw Error("Can't create secondary domain capable XhrIo object.");return l=i.Aa&&!i.ma?new le(new xr({ab:u})):new le(i.ma),l.Fa(i.L),l}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function ha(){}n=ha.prototype,n.ra=function(){},n.qa=function(){},n.pa=function(){},n.oa=function(){},n.isActive=function(){return!0},n.Ka=function(){};function ps(){}ps.prototype.g=function(i,l){return new ke(i,l)};function ke(i,l){Te.call(this),this.g=new ta(l),this.l=i,this.h=l&&l.messageUrlParams||null,i=l&&l.messageHeaders||null,l&&l.clientProtocolHeaderRequired&&(i?i["X-Client-Protocol"]="webchannel":i={"X-Client-Protocol":"webchannel"}),this.g.o=i,i=l&&l.initMessageHeaders||null,l&&l.messageContentType&&(i?i["X-WebChannel-Content-Type"]=l.messageContentType:i={"X-WebChannel-Content-Type":l.messageContentType}),l&&l.sa&&(i?i["X-WebChannel-Client-Profile"]=l.sa:i={"X-WebChannel-Client-Profile":l.sa}),this.g.U=i,(i=l&&l.Qb)&&!y(i)&&(this.g.u=i),this.A=l&&l.supportsCrossDomainXhr||!1,this.v=l&&l.sendRawJson||!1,(l=l&&l.httpSessionIdParam)&&!y(l)&&(this.g.G=l,i=this.h,i!==null&&l in i&&(i=this.h,l in i&&delete i[l])),this.j=new Ut(this)}p(ke,Te),ke.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},ke.prototype.close=function(){kr(this.g)},ke.prototype.o=function(i){var l=this.g;if(typeof i=="string"){var u={};u.__data__=i,i=u}else this.v&&(u={},u.__data__=br(i),i=u);l.i.push(new ed(l.Ya++,i)),l.I==3&&fs(l)},ke.prototype.N=function(){this.g.l=null,delete this.j,kr(this.g),delete this.g,ke.Z.N.call(this)};function fa(i){Tr.call(this),i.__headers__&&(this.headers=i.__headers__,this.statusCode=i.__status__,delete i.__headers__,delete i.__status__);var l=i.__sm__;if(l){e:{for(const u in l){i=u;break e}i=void 0}(this.i=i)&&(i=this.i,l=l!==null&&i in l?l[i]:void 0),this.data=l}else this.data=i}p(fa,Tr);function ma(){wr.call(this),this.status=1}p(ma,wr);function Ut(i){this.g=i}p(Ut,ha),Ut.prototype.ra=function(){Ce(this.g,"a")},Ut.prototype.qa=function(i){Ce(this.g,new fa(i))},Ut.prototype.pa=function(i){Ce(this.g,new ma)},Ut.prototype.oa=function(){Ce(this.g,"b")},ps.prototype.createWebChannel=ps.prototype.g,ke.prototype.send=ke.prototype.o,ke.prototype.open=ke.prototype.m,ke.prototype.close=ke.prototype.close,Xl=function(){return new ps},Yl=function(){return os()},Kl=wt,si={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},as.NO_ERROR=0,as.TIMEOUT=8,as.HTTP_ERROR=6,Is=as,Do.COMPLETE="complete",Wl=Do,Ao.EventType=un,un.OPEN="a",un.CLOSE="b",un.ERROR="c",un.MESSAGE="d",Te.prototype.listen=Te.prototype.J,Sn=Ao,le.prototype.listenOnce=le.prototype.K,le.prototype.getLastError=le.prototype.Ha,le.prototype.getLastErrorCode=le.prototype.ya,le.prototype.getStatus=le.prototype.ca,le.prototype.getResponseJson=le.prototype.La,le.prototype.getResponseText=le.prototype.la,le.prototype.send=le.prototype.ea,le.prototype.setWithCredentials=le.prototype.Fa,Ql=le}).apply(typeof vs<"u"?vs:typeof self<"u"?self:typeof window<"u"?window:{});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sc="";function wf(n){let e="";for(let t=0;t<n.length;t++)e.length>0&&(e=Na(e)),e=If(n.get(t),e);return Na(e)}function If(n,e){let t=e;const s=n.length;for(let r=0;r<s;r++){const o=n.charAt(r);switch(o){case"\0":t+="";break;case sc:t+="";break;default:t+=o}}return t}function Na(n){return n+sc+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qs{constructor(e,t){this.position=e,this.inclusive=t}}function Ba(n,e,t){let s=0;for(let r=0;r<n.position.length;r++){const o=e[r],a=n.position[r];if(o.field.isKeyField()?s=j.comparator(j.fromName(a.referenceValue),t.key):s=Xt(a,t.data.field(o.field)),o.dir==="desc"&&(s*=-1),s!==0)break}return s}function Ua(n,e){if(n===null)return e===null;if(e===null||n.inclusive!==e.inclusive||n.position.length!==e.position.length)return!1;for(let t=0;t<n.position.length;t++)if(!Qe(n.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jf=new oe(j.comparator);function Ze(){return Jf}const Tc=new oe(j.comparator);function Rn(...n){let e=Tc;for(const t of n)e=e.insert(t.key,t);return e}function wc(n){let e=Tc;return n.forEach(((t,s)=>e=e.insert(t,s.overlayedDocument))),e}function Pt(){return Nn()}function Ic(){return Nn()}function Nn(){return new Ot((n=>n.toString()),((n,e)=>n.isEqual(e)))}const Qf=new oe(j.comparator),Wf=new ge(j.comparator);function K(...n){let e=Wf;for(const t of n)e=e.add(t);return e}const Kf=new ge(W);function Yf(){return Kf}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tm{constructor(e,t){this.field=e,this.transform=t}}function nm(n,e){return n.field.isEqual(e.field)&&(function(s,r){return s instanceof zn&&r instanceof zn||s instanceof Gn&&r instanceof Gn?Yt(s.elements,r.elements,Qe):s instanceof Us&&r instanceof Us?Qe(s.Ae,r.Ae):s instanceof jn&&r instanceof jn})(n.transform,e.transform)}class sm{constructor(e,t){this.version=e,this.transformResults=t}}class Fe{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new Fe}static exists(e){return new Fe(void 0,e)}static updateTime(e){return new Fe(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Rs(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class nr{}function Dc(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new ki(n.key,Fe.none()):new Jn(n.key,n.data,Fe.none());{const t=n.data,s=Ne.empty();let r=new ge(Ee.comparator);for(let o of e.fields)if(!r.has(o)){let a=t.field(o);a===null&&o.length>1&&(o=o.popLast(),a=t.field(o)),a===null?s.delete(o):s.set(o,a),r=r.add(o)}return new Tt(n.key,s,new Le(r.toArray()),Fe.none())}}function rm(n,e,t){n instanceof Jn?(function(r,o,a){const c=r.value.clone(),d=Ja(r.fieldTransforms,o,a.transformResults);c.setAll(d),o.convertToFoundDocument(a.version,c).setHasCommittedMutations()})(n,e,t):n instanceof Tt?(function(r,o,a){if(!Rs(r.precondition,o))return void o.convertToUnknownDocument(a.version);const c=Ja(r.fieldTransforms,o,a.transformResults),d=o.data;d.setAll(Vc(r)),d.setAll(c),o.convertToFoundDocument(a.version,d).setHasCommittedMutations()})(n,e,t):(function(r,o,a){o.convertToNoDocument(a.version).setHasCommittedMutations()})(0,e,t)}function kn(n,e,t,s){return n instanceof Jn?(function(o,a,c,d){if(!Rs(o.precondition,a))return c;const h=o.value.clone(),f=Qa(o.fieldTransforms,d,a);return h.setAll(f),a.convertToFoundDocument(a.version,h).setHasLocalMutations(),null})(n,e,t,s):n instanceof Tt?(function(o,a,c,d){if(!Rs(o.precondition,a))return c;const h=Qa(o.fieldTransforms,d,a),f=a.data;return f.setAll(Vc(o)),f.setAll(h),a.convertToFoundDocument(a.version,f).setHasLocalMutations(),c===null?null:c.unionWith(o.fieldMask.fields).unionWith(o.fieldTransforms.map((p=>p.field)))})(n,e,t,s):(function(o,a,c){return Rs(o.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):c})(n,e,t)}function im(n,e){let t=null;for(const s of n.fieldTransforms){const r=e.data.field(s.field),o=Sc(s.transform,r||null);o!=null&&(t===null&&(t=Ne.empty()),t.set(s.field,o))}return t||null}function Ha(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!(function(s,r){return s===void 0&&r===void 0||!(!s||!r)&&Yt(s,r,((o,a)=>nm(o,a)))})(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class Jn extends nr{constructor(e,t,s,r=[]){super(),this.key=e,this.value=t,this.precondition=s,this.fieldTransforms=r,this.type=0}getFieldMask(){return null}}class Tt extends nr{constructor(e,t,s,r,o=[]){super(),this.key=e,this.data=t,this.fieldMask=s,this.precondition=r,this.fieldTransforms=o,this.type=1}getFieldMask(){return this.fieldMask}}function Vc(n){const e=new Map;return n.fieldMask.fields.forEach((t=>{if(!t.isEmpty()){const s=n.data.field(t);e.set(t,s)}})),e}function Ja(n,e,t){const s=new Map;te(n.length===t.length,32656,{Ve:t.length,de:n.length});for(let r=0;r<t.length;r++){const o=n[r],a=o.transform,c=e.data.field(o.field);s.set(o.field,em(a,c,t[r]))}return s}function Qa(n,e,t){const s=new Map;for(const r of n){const o=r.transform,a=t.data.field(r.field);s.set(r.field,Zf(o,a,e))}return s}class ki extends nr{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class om extends nr{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sr{constructor(e,t,s,r,o){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=s,this.documentUpdates=r,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(e,t,s){const r=new Map;return r.set(e,Qn.createSynthesizedTargetChangeForCurrentChange(e,t,s)),new sr(G.min(),r,new oe(W),Ze(),K())}}class Qn{constructor(e,t,s,r,o){this.resumeToken=e,this.current=t,this.addedDocuments=s,this.modifiedDocuments=r,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(e,t,s){return new Qn(s,t,K(),K(),K())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Um{constructor(e,t,s,r){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=s,this.indexManager=r}getDocument(e,t){let s=null;return this.documentOverlayCache.getOverlay(e,t).next((r=>(s=r,this.remoteDocumentCache.getEntry(e,t)))).next((r=>(s!==null&&kn(s.mutation,r,Le.empty(),ie.now()),r)))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next((s=>this.getLocalViewOfDocuments(e,s,K()).next((()=>s))))}getLocalViewOfDocuments(e,t,s=K()){const r=Pt();return this.populateOverlays(e,r,t).next((()=>this.computeViews(e,t,r,s).next((o=>{let a=Rn();return o.forEach(((c,d)=>{a=a.insert(c,d.overlayedDocument)})),a}))))}getOverlayedDocuments(e,t){const s=Pt();return this.populateOverlays(e,s,t).next((()=>this.computeViews(e,t,s,K())))}populateOverlays(e,t,s){const r=[];return s.forEach((o=>{t.has(o)||r.push(o)})),this.documentOverlayCache.getOverlays(e,r).next((o=>{o.forEach(((a,c)=>{t.set(a,c)}))}))}computeViews(e,t,s,r){let o=Ze();const a=Nn(),c=(function(){return Nn()})();return t.forEach(((d,h)=>{const f=s.get(h.key);r.has(h.key)&&(f===void 0||f.mutation instanceof Tt)?o=o.insert(h.key,h):f!==void 0?(a.set(h.key,f.mutation.getFieldMask()),kn(f.mutation,h,f.mutation.getFieldMask(),ie.now())):a.set(h.key,Le.empty())})),this.recalculateAndSaveOverlays(e,o).next((d=>(d.forEach(((h,f)=>a.set(h,f))),t.forEach(((h,f)=>c.set(h,new Bm(f,a.get(h)??null)))),c)))}recalculateAndSaveOverlays(e,t){const s=Nn();let r=new oe(((a,c)=>a-c)),o=K();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next((a=>{for(const c of a)c.keys().forEach((d=>{const h=t.get(d);if(h===null)return;let f=s.get(d)||Le.empty();f=c.applyToLocalView(h,f),s.set(d,f);const p=(r.get(c.batchId)||K()).add(d);r=r.insert(c.batchId,p)}))})).next((()=>{const a=[],c=r.getReverseIterator();for(;c.hasNext();){const d=c.getNext(),h=d.key,f=d.value,p=Ic();f.forEach((E=>{if(!o.has(E)){const A=Dc(t.get(E),s.get(E));A!==null&&p.set(E,A),o=o.add(E)}})),a.push(this.documentOverlayCache.saveOverlays(e,h,p))}return P.waitFor(a)})).next((()=>s))}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next((s=>this.recalculateAndSaveOverlays(e,s)))}getDocumentsMatchingQuery(e,t,s,r){return Uf(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):_c(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,s,r):this.getDocumentsMatchingCollectionQuery(e,t,s,r)}getNextDocuments(e,t,s,r){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,s,r).next((o=>{const a=r-o.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,s.largestBatchId,r-o.size):P.resolve(Pt());let c=Fn,d=o;return a.next((h=>P.forEach(h,((f,p)=>(c<p.largestBatchId&&(c=p.largestBatchId),o.get(f)?P.resolve():this.remoteDocumentCache.getEntry(e,f).next((E=>{d=d.insert(f,E)}))))).next((()=>this.populateOverlays(e,h,o))).next((()=>this.computeViews(e,d,h,K()))).next((f=>({batchId:c,changes:wc(f)})))))}))}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new j(t)).next((s=>{let r=Rn();return s.isFoundDocument()&&(r=r.insert(s.key,s)),r}))}getDocumentsMatchingCollectionGroupQuery(e,t,s,r){const o=t.collectionGroup;let a=Rn();return this.indexManager.getCollectionParents(e,o).next((c=>P.forEach(c,(d=>{const h=(function(p,E){return new an(E,null,p.explicitOrderBy.slice(),p.filters.slice(),p.limit,p.limitType,p.startAt,p.endAt)})(t,d.child(o));return this.getDocumentsMatchingCollectionQuery(e,h,s,r).next((f=>{f.forEach(((p,E)=>{a=a.insert(p,E)}))}))})).next((()=>a))))}getDocumentsMatchingCollectionQuery(e,t,s,r){let o;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,s.largestBatchId).next((a=>(o=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,s,o,r)))).next((a=>{o.forEach(((d,h)=>{const f=h.getKey();a.get(f)===null&&(a=a.insert(f,Se.newInvalidDocument(f)))}));let c=Rn();return a.forEach(((d,h)=>{const f=o.get(d);f!==void 0&&kn(f.mutation,h,Le.empty(),ie.now()),er(t,h)&&(c=c.insert(d,h))})),c}))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jm{constructor(e){this.ti=e,this.docs=(function(){return new oe(j.comparator)})(),this.size=0}setIndexManager(e){this.indexManager=e}addEntry(e,t){const s=t.key,r=this.docs.get(s),o=r?r.size:0,a=this.ti(t);return this.docs=this.docs.insert(s,{document:t.mutableCopy(),size:a}),this.size+=a-o,this.indexManager.addToCollectionParentIndex(e,s.path.popLast())}removeEntry(e){const t=this.docs.get(e);t&&(this.docs=this.docs.remove(e),this.size-=t.size)}getEntry(e,t){const s=this.docs.get(t);return P.resolve(s?s.document.mutableCopy():Se.newInvalidDocument(t))}getEntries(e,t){let s=Ze();return t.forEach((r=>{const o=this.docs.get(r);s=s.insert(r,o?o.document.mutableCopy():Se.newInvalidDocument(r))})),P.resolve(s)}getDocumentsMatchingQuery(e,t,s,r){let o=Ze();const a=t.path,c=new j(a.child("__id-9223372036854775808__")),d=this.docs.getIteratorFrom(c);for(;d.hasNext();){const{key:h,value:{document:f}}=d.getNext();if(!a.isPrefixOf(h.path))break;h.path.length>a.length+1||vf(yf(f),s)<=0||(r.has(f.key)||er(t,f))&&(o=o.insert(f.key,f.mutableCopy()))}return P.resolve(o)}getAllFromCollectionGroup(e,t,s,r){z(9500)}ni(e,t){return P.forEach(this.docs,(s=>t(s)))}newChangeBuffer(e){return new Qm(this)}getSize(e){return P.resolve(this.size)}}class Qm extends qm{constructor(e){super(),this.Mr=e}applyChanges(e){const t=[];return this.changes.forEach(((s,r)=>{r.isValidDocument()?t.push(this.Mr.addEntry(e,r)):this.Mr.removeEntry(s)})),P.waitFor(t)}getFromCache(e,t){return this.Mr.getEntry(e,t)}getAllFromCache(e,t){return this.Mr.getEntries(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zr="RestConnection",up={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class dp{get Ko(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),r=encodeURIComponent(this.databaseId.database);this.qo=t+"://"+e.host,this.Uo=`projects/${s}/databases/${r}`,this.$o=this.databaseId.database===Fs?`project_id=${s}`:`project_id=${s}&database_id=${r}`}Wo(e,t,s,r,o){const a=pi(),c=this.Qo(e,t.toUriEncodedString());F(zr,`Sending RPC '${e}' ${a}:`,c,s);const d={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.$o};this.Go(d,r,o);const{host:h}=new URL(c),f=wi(h);return this.zo(e,c,d,s,f).then((p=>(F(zr,`Received RPC '${e}' ${a}: `,p),p)),(p=>{throw Nt(zr,`RPC '${e}' ${a} failed with error: `,p,"url: ",c,"request:",s),p}))}jo(e,t,s,r,o,a){return this.Wo(e,t,s,r,o)}Go(e,t,s){e["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+sn})(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach(((r,o)=>e[o]=r)),s&&s.headers.forEach(((r,o)=>e[o]=r))}Qo(e,t){const s=up[e];let r=`${this.qo}/v1/${t}:${s}`;return this.databaseInfo.apiKey&&(r=`${r}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),r}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const we="WebChannelConnection",An=(n,e,t)=>{n.listen(e,(s=>{try{t(s)}catch(r){setTimeout((()=>{throw r}),0)}}))};class Wt extends dp{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!Wt.c_){const e=Yl();An(e,Kl.STAT_EVENT,(t=>{t.stat===si.PROXY?F(we,"STAT_EVENT: detected buffering proxy"):t.stat===si.NOPROXY&&F(we,"STAT_EVENT: detected no buffering proxy")})),Wt.c_=!0}}zo(e,t,s,r,o){const a=pi();return new Promise(((c,d)=>{const h=new Ql;h.setWithCredentials(!0),h.listenOnce(Wl.COMPLETE,(()=>{try{switch(h.getLastErrorCode()){case Is.NO_ERROR:const p=h.getResponseJson();F(we,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(p)),c(p);break;case Is.TIMEOUT:F(we,`RPC '${e}' ${a} timed out`),d(new M(C.DEADLINE_EXCEEDED,"Request time out"));break;case Is.HTTP_ERROR:const E=h.getStatus();if(F(we,`RPC '${e}' ${a} failed with status:`,E,"response text:",h.getResponseText()),E>0){let A=h.getResponseJson();Array.isArray(A)&&(A=A[0]);const R=A==null?void 0:A.error;if(R&&R.status&&R.message){const V=(function(D){const k=D.toLowerCase().replace(/_/g,"-");return Object.values(C).indexOf(k)>=0?k:C.UNKNOWN})(R.status);d(new M(V,R.message))}else d(new M(C.UNKNOWN,"Server responded with status "+h.getStatus()))}else d(new M(C.UNAVAILABLE,"Connection failed."));break;default:z(9055,{l_:e,streamId:a,h_:h.getLastErrorCode(),P_:h.getLastError()})}}finally{F(we,`RPC '${e}' ${a} completed.`)}}));const f=JSON.stringify(r);F(we,`RPC '${e}' ${a} sending request:`,r),h.send(t,"POST",f,s,15)}))}T_(e,t,s){const r=pi(),o=[this.qo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=this.createWebChannelTransport(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(c.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(c.useFetchStreams=!0),this.Go(c.initMessageHeaders,t,s),c.encodeInitMessageHeaders=!0;const h=o.join("");F(we,`Creating RPC '${e}' stream ${r}: ${h}`,c);const f=a.createWebChannel(h,c);this.I_(f);let p=!1,E=!1;const A=new hp({Ho:R=>{E?F(we,`Not sending because RPC '${e}' stream ${r} is closed:`,R):(p||(F(we,`Opening RPC '${e}' stream ${r} transport.`),f.open(),p=!0),F(we,`RPC '${e}' stream ${r} sending:`,R),f.send(R))},Jo:()=>f.close()});return An(f,Sn.EventType.OPEN,(()=>{E||(F(we,`RPC '${e}' stream ${r} transport opened.`),A.i_())})),An(f,Sn.EventType.CLOSE,(()=>{E||(E=!0,F(we,`RPC '${e}' stream ${r} transport closed`),A.o_(),this.E_(f))})),An(f,Sn.EventType.ERROR,(R=>{E||(E=!0,Nt(we,`RPC '${e}' stream ${r} transport errored. Name:`,R.name,"Message:",R.message),A.o_(new M(C.UNAVAILABLE,"The operation could not be completed")))})),An(f,Sn.EventType.MESSAGE,(R=>{var V;if(!E){const x=R.data[0];te(!!x,16349);const D=x,k=(D==null?void 0:D.error)||((V=D[0])==null?void 0:V.error);if(k){F(we,`RPC '${e}' stream ${r} received error:`,k);const q=k.status;let $=(function(T){const _=de[T];if(_!==void 0)return xc(_)})(q),N=k.message;q==="NOT_FOUND"&&N.includes("database")&&N.includes("does not exist")&&N.includes(this.databaseId.database)&&Nt(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),$===void 0&&($=C.INTERNAL,N="Unknown error status: "+q+" with message "+k.message),E=!0,A.o_(new M($,N)),f.close()}else F(we,`RPC '${e}' stream ${r} received:`,x),A.__(x)}})),Wt.u_(),setTimeout((()=>{A.s_()}),0),A}terminate(){this.a_.forEach((e=>e.close())),this.a_=[]}I_(e){this.a_.push(e)}E_(e){this.a_=this.a_.filter((t=>t===e))}Go(e,t,s){super.Go(e,t,s),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return Xl()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xp{constructor(){this.wa=void 0,this.ba=[]}Sa(){return this.ba.some((e=>e.Da()))}}class Np{constructor(){this.queries=ul(),this.onlineState="Unknown",this.Ca=new Set}terminate(){(function(t,s){const r=H(t),o=r.queries;r.queries=ul(),o.forEach(((a,c)=>{for(const d of c.ba)d.onError(s)}))})(this,new M(C.ABORTED,"Firestore shutting down"))}}function ul(){return new Ot((n=>Ec(n)),Zs)}async function tu(n,e){const t=H(n);let s=3;const r=e.query;let o=t.queries.get(r);o?!o.Sa()&&e.Da()&&(s=2):(o=new xp,s=e.Da()?0:1);try{switch(s){case 0:o.wa=await t.onListen(r,!0);break;case 1:o.wa=await t.onListen(r,!1);break;case 2:await t.onFirstRemoteStoreListen(r)}}catch(a){const c=Ji(a,`Initialization of query '${Gt(e.query)}' failed`);return void e.onError(c)}t.queries.set(r,o),o.ba.push(e),e.va(t.onlineState),o.wa&&e.Fa(o.wa)&&Qi(t)}async function nu(n,e){const t=H(n),s=e.query;let r=3;const o=t.queries.get(s);if(o){const a=o.ba.indexOf(e);a>=0&&(o.ba.splice(a,1),o.ba.length===0?r=e.Da()?0:1:!o.Sa()&&e.Da()&&(r=2))}switch(r){case 0:return t.queries.delete(s),t.onUnlisten(s,!0);case 1:return t.queries.delete(s),t.onUnlisten(s,!1);case 2:return t.onLastRemoteStoreUnlisten(s);default:return}}function kp(n,e){const t=H(n);let s=!1;for(const r of e){const o=r.query,a=t.queries.get(o);if(a){for(const c of a.ba)c.Fa(r)&&(s=!0);a.wa=r}}s&&Qi(t)}function Lp(n,e,t){const s=H(n),r=s.queries.get(e);if(r)for(const o of r.ba)o.onError(t);s.queries.delete(e)}function Qi(n){n.Ca.forEach((e=>{e.next()}))}var gi,dl;(dl=gi||(gi={})).Ma="default",dl.Cache="cache";class su{constructor(e,t,s){this.query=e,this.xa=t,this.Oa=!1,this.Na=null,this.onlineState="Unknown",this.options=s||{}}Fa(e){if(!this.options.includeMetadataChanges){const s=[];for(const r of e.docChanges)r.type!==3&&s.push(r);e=new tn(e.query,e.docs,e.oldDocs,s,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let t=!1;return this.Oa?this.Ba(e)&&(this.xa.next(e),t=!0):this.La(e,this.onlineState)&&(this.ka(e),t=!0),this.Na=e,t}onError(e){this.xa.error(e)}va(e){this.onlineState=e;let t=!1;return this.Na&&!this.Oa&&this.La(this.Na,e)&&(this.ka(this.Na),t=!0),t}La(e,t){if(!e.fromCache||!this.Da())return!0;const s=t!=="Offline";return(!this.options.Ka||!s)&&(!e.docs.isEmpty()||e.hasCachedResults||t==="Offline")}Ba(e){if(e.docChanges.length>0)return!0;const t=this.Na&&this.Na.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&this.options.includeMetadataChanges===!0}ka(e){e=tn.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.Oa=!0,this.xa.next(e)}Da(){return this.options.source!==gi.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dg=/^__.*__$/;class hg{constructor(e,t,s){this.data=e,this.fieldMask=t,this.fieldTransforms=s}toMutation(e,t){return this.fieldMask!==null?new Tt(e,this.data,this.fieldMask,t,this.fieldTransforms):new Jn(e,this.data,t,this.fieldTransforms)}}class gu{constructor(e,t,s){this.data=e,this.fieldMask=t,this.fieldTransforms=s}toMutation(e,t){return new Tt(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function yu(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw z(40011,{dataSource:n})}}class Zi{constructor(e,t,s,r,o,a){this.settings=e,this.databaseId=t,this.serializer=s,this.ignoreUndefinedProperties=r,o===void 0&&this.validatePath(),this.fieldTransforms=o||[],this.fieldMask=a||[]}get path(){return this.settings.path}get dataSource(){return this.settings.dataSource}contextWith(e){return new Zi({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}childContextForField(e){var r;const t=(r=this.path)==null?void 0:r.child(e),s=this.contextWith({path:t,arrayElement:!1});return s.validatePathSegment(e),s}childContextForFieldPath(e){var r;const t=(r=this.path)==null?void 0:r.child(e),s=this.contextWith({path:t,arrayElement:!1});return s.validatePath(),s}childContextForArray(e){return this.contextWith({path:void 0,arrayElement:!0})}createError(e){return Js(e,this.settings.methodName,this.settings.hasConverter||!1,this.path,this.settings.targetDoc)}contains(e){return this.fieldMask.find((t=>e.isPrefixOf(t)))!==void 0||this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))!==void 0}validatePath(){if(this.path)for(let e=0;e<this.path.length;e++)this.validatePathSegment(this.path.get(e))}validatePathSegment(e){if(e.length===0)throw this.createError("Document fields must not be empty");if(yu(this.dataSource)&&dg.test(e))throw this.createError('Document fields cannot begin and end with "__"')}}class fg{constructor(e,t,s){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=s||rr(e)}createContext(e,t,s,r=!1){return new Zi({dataSource:e,methodName:t,targetDoc:s,path:Ee.emptyPath(),arrayElement:!1,hasConverter:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function cr(n){const e=n._freezeSettings(),t=rr(n._databaseId);return new fg(n._databaseId,!!e.ignoreUndefinedProperties,t)}function vu(n,e,t,s,r,o={}){const a=n.createContext(o.merge||o.mergeFields?2:0,e,t,r);to("Data must be an object, but it was:",a,s);const c=_u(s,a);let d,h;if(o.merge)d=new Le(a.fieldMask),h=a.fieldTransforms;else if(o.mergeFields){const f=[];for(const p of o.mergeFields){const E=Lt(e,p,t);if(!a.contains(E))throw new M(C.INVALID_ARGUMENT,`Field '${E}' is specified in your field mask but missing from your input data.`);Tu(f,E)||f.push(E)}d=new Le(f),h=a.fieldTransforms.filter((p=>d.covers(p.field)))}else d=null,h=a.fieldTransforms;return new hg(new Ne(c),d,h)}class ur extends lr{_toFieldTransform(e){if(e.dataSource!==2)throw e.dataSource===1?e.createError(`${this._methodName}() can only appear at the top level of your update data`):e.createError(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof ur}}class eo extends lr{_toFieldTransform(e){return new tm(e.path,new jn)}isEqual(e){return e instanceof eo}}function mg(n,e,t,s){const r=n.createContext(1,e,t);to("Data must be an object, but it was:",r,s);const o=[],a=Ne.empty();bt(s,((d,h)=>{const f=bu(e,d,t);h=Je(h);const p=r.childContextForFieldPath(f);if(h instanceof ur)o.push(f);else{const E=Yn(h,p);E!=null&&(o.push(f),a.set(f,E))}}));const c=new Le(o);return new gu(a,c,r.fieldTransforms)}function pg(n,e,t,s,r,o){const a=n.createContext(1,e,t),c=[Lt(e,s,t)],d=[r];if(o.length%2!=0)throw new M(C.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let E=0;E<o.length;E+=2)c.push(Lt(e,o[E])),d.push(o[E+1]);const h=[],f=Ne.empty();for(let E=c.length-1;E>=0;--E)if(!Tu(h,c[E])){const A=c[E];let R=d[E];R=Je(R);const V=a.childContextForFieldPath(A);if(R instanceof ur)h.push(A);else{const x=Yn(R,V);x!=null&&(h.push(A),f.set(A,x))}}const p=new Le(h);return new gu(f,p,a.fieldTransforms)}function gg(n,e,t,s=!1){return Yn(t,n.createContext(s?4:3,e))}function Yn(n,e){if(Eu(n=Je(n)))return to("Unsupported field value:",e,n),_u(n,e);if(n instanceof lr)return(function(s,r){if(!yu(r.dataSource))throw r.createError(`${s._methodName}() can only be used with update() and set()`);if(!r.path)throw r.createError(`${s._methodName}() is not currently supported inside arrays`);const o=s._toFieldTransform(r);o&&r.fieldTransforms.push(o)})(n,e),null;if(n===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),n instanceof Array){if(e.settings.arrayElement&&e.dataSource!==4)throw e.createError("Nested arrays are not supported");return(function(s,r){const o=[];let a=0;for(const c of s){let d=Yn(c,r.childContextForArray(a));d==null&&(d={nullValue:"NULL_VALUE"}),o.push(d),a++}return{arrayValue:{values:o}}})(n,e)}return(function(s,r){if((s=Je(s))===null)return{nullValue:"NULL_VALUE"};if(typeof s=="number")return Xf(r.serializer,s);if(typeof s=="boolean")return{booleanValue:s};if(typeof s=="string")return{stringValue:s};if(s instanceof Date){const o=ie.fromDate(s);return{timestampValue:js(r.serializer,o)}}if(s instanceof ie){const o=new ie(s.seconds,1e3*Math.floor(s.nanoseconds/1e3));return{timestampValue:js(r.serializer,o)}}if(s instanceof He)return{geoPointValue:{latitude:s.latitude,longitude:s.longitude}};if(s instanceof Me)return{bytesValue:Lc(r.serializer,s._byteString)};if(s instanceof ue){const o=r.databaseId,a=s.firestore._databaseId;if(!a.isEqual(o))throw r.createError(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${o.projectId}/${o.database}`);return{referenceValue:Oi(s.firestore._databaseId||r.databaseId,s._key.path)}}if(s instanceof $e)return(function(a,c){const d=a instanceof $e?a.toArray():a;return{mapValue:{fields:{[uc]:{stringValue:dc},[$s]:{arrayValue:{values:d.map((f=>{if(typeof f!="number")throw c.createError("VectorValues must only contain numeric values.");return Ni(c.serializer,f)}))}}}}}})(s,r);if(Uc(s))return s._toProto(r.serializer);throw r.createError(`Unsupported field value: ${Ws(s)}`)})(n,e)}function _u(n,e){const t={};return rc(n)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):bt(n,((s,r)=>{const o=Yn(r,e.childContextForField(s));o!=null&&(t[s]=o)})),{mapValue:{fields:t}}}function Eu(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof ie||n instanceof He||n instanceof Me||n instanceof ue||n instanceof lr||n instanceof $e||Uc(n))}function to(n,e,t){if(!Eu(t)||!nc(t)){const s=Ws(t);throw s==="an object"?e.createError(n+" a custom object"):e.createError(n+" "+s)}}function Lt(n,e,t){if((e=Je(e))instanceof Xi)return e._internalPath;if(typeof e=="string")return bu(n,e);throw Js("Field path arguments must be of type string or ",n,!1,void 0,t)}const yg=new RegExp("[~\\*/\\[\\]]");function bu(n,e,t){if(e.search(yg)>=0)throw Js(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,t);try{return new Xi(...e.split("."))._internalPath}catch{throw Js(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,t)}}function Js(n,e,t,s,r){const o=s&&!s.isEmpty(),a=r!==void 0;let c=`Function ${e}() called with invalid data`;t&&(c+=" (via `toFirestore()`)"),c+=". ";let d="";return(o||a)&&(d+=" (found",o&&(d+=` in field ${s}`),a&&(d+=` in document ${r}`),d+=")"),new M(C.INVALID_ARGUMENT,c+n+d)}function Tu(n,e){return n.some((t=>t.isEqual(e)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wl(n){return(function(t,s){if(typeof t!="object"||t===null)return!1;const r=t;for(const o of s)if(o in r&&typeof r[o]=="function")return!0;return!1})(n,["next","error","complete"])}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */Vt._jsonSchemaVersion="firestore/querySnapshot/1.0",Vt._jsonSchema={type:fe("string",Vt._jsonSchemaVersion),bundleSource:fe("string","QuerySnapshot"),bundleName:fe("string"),bundle:fe("string")};function Wr(n){n=Oe(n,et);const e=Oe(n.firestore,Et),t=Yi(e),s=new no(e);return Iu(n._query),rg(t,n._query).then((r=>new Vt(e,s,n,r)))}function Tg(n,e,t){n=Oe(n,ue);const s=Oe(n.firestore,Et),r=Su(n.converter,e,t),o=cr(s);return hr(s,[vu(o,"setDoc",n._key,r,n.converter!==null,t).toMutation(n._key,Fe.none())])}function ws(n,e,t,...s){n=Oe(n,ue);const r=Oe(n.firestore,Et),o=cr(r);let a;return a=typeof(e=Je(e))=="string"||e instanceof Xi?pg(o,"updateDoc",n._key,e,t,s):mg(o,"updateDoc",n._key,e),hr(r,[a.toMutation(n._key,Fe.exists(!0))])}function Rl(n){return hr(Oe(n.firestore,Et),[new ki(n._key,Fe.none())])}function Kr(n,e){const t=Oe(n.firestore,Et),s=We(n),r=Su(n.converter,e),o=cr(n.firestore);return hr(t,[vu(o,"addDoc",s._key,r,n.converter!==null,{}).toMutation(s._key,Fe.exists(!1))]).then((()=>s))}function Cl(n,...e){var h,f,p;n=Je(n);let t={includeMetadataChanges:!1,source:"default"},s=0;typeof e[s]!="object"||wl(e[s])||(t=e[s++]);const r={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(wl(e[s])){const E=e[s];e[s]=(h=E.next)==null?void 0:h.bind(E),e[s+1]=(f=E.error)==null?void 0:f.bind(E),e[s+2]=(p=E.complete)==null?void 0:p.bind(E)}let o,a,c;if(n instanceof ue)a=Oe(n.firestore,Et),c=xi(n._key.path),o={next:E=>{e[s]&&e[s](wg(a,n,E))},error:e[s+1],complete:e[s+2]};else{const E=Oe(n,et);a=Oe(E.firestore,Et),c=E._query;const A=new no(a);o={next:R=>{e[s]&&e[s](new Vt(a,A,E,R))},error:e[s+1],complete:e[s+2]},Iu(n._query)}const d=Yi(a);return sg(d,c,r,o)}function hr(n,e){const t=Yi(n);return ig(t,e)}function wg(n,e,t){const s=t.docs.get(e._key),r=new no(n);return new Dt(n,r,e._key,s,new Pn(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){sf(jh),Ms(new Mn("firestore",((s,{instanceIdentifier:r,options:o})=>{const a=s.getProvider("app").getImmediate(),c=new Et(new af(s.getProvider("auth-internal")),new uf(a,s.getProvider("app-check-internal")),Rf(a,r),a);return o={useFetchStreams:t,...o},c._setSettings(o),c}),"PUBLIC").setMultipleInstances(!0)),Qt(bl,Tl,e),Qt(bl,Tl,"esm2020")})();const Ig={apiKey:"AIzaSyD90SkLA57LCNnPRCDp5-sA6x2lF0oasMc",authDomain:"comebiblia-43643.firebaseapp.com",projectId:"comebiblia-43643",storageBucket:"comebiblia-43643.firebasestorage.app",messagingSenderId:"704190300094",appId:"1:704190300094:web:0a726168ed731032d803ef",measurementId:"G-DZPX4SB193"},Ag=zl(Ig),De=cg(Ag),Ru="player",Cu={name:"Jugador",avatar:"😊",level:1,xp:0,coins:50,totalGamesPlayed:0,totalCorrectAnswers:0,totalScore:0,gamesCompleted:{},bestScores:{},leaguePoints:0,league:"Pescador",createdAt:Date.now()},Ln=[0,100,250,500,800,1200,1700,2300,3e3,3800,4700,5700,6800,8e3,9500,11e3,13e3,15e3,17500,2e4],Pl=["Semilla","Brote","Plantita","Arbusto","Árbol Joven","Roble","Cedro del Líbano","Discípulo","Apóstol","Profeta","Siervo Fiel","Guerrero de Fe","Sabio","Maestro","Pastor","Evangelista","Misionero","Guardián","Ángel","Leyenda Bíblica"],Sg=["😊","😇","🙏","✝️","⭐","👑","🕊️","🌟","💪","🎯","📖","🏆"];let J=null;function Re(){return J||(J=Ml(Ru,{...Cu})),{...J}}function $t(){Ll(Ru,J)}function Pu(n){J||Re(),J.name=n.trim()||"Jugador",$t()}function Rg(n){J||Re(),J.avatar=n,$t()}function Xn(n){J||Re(),J.xp+=n;let e=!1;for(;J.level<Ln.length&&J.xp>=Ln[J.level];)J.level++,e=!0;return $t(),e}function Zn(n){J||Re(),J.coins+=n,$t(),fr()}function es(n,e,t=0){J||Re(),J.totalGamesPlayed++,J.totalScore+=e,J.totalCorrectAnswers+=t,J.gamesCompleted[n]||(J.gamesCompleted[n]=0),J.gamesCompleted[n]++,(!J.bestScores[n]||e>J.bestScores[n])&&(J.bestScores[n]=e),$t()}function Cg(){const n=Re();if(n.level>=Ln.length)return{current:n.xp,needed:n.xp,progress:1};const e=Ln[n.level-1]||0,t=Ln[n.level],s=(n.xp-e)/(t-e);return{current:n.xp-e,needed:t-e,progress:Math.min(s,1)}}function Pg(n=null){const e=n||Re().level;return Pl[Math.min(e-1,Pl.length-1)]}function Dg(){return[...Sg]}function Vg(){J={...Cu,createdAt:Date.now()},$t(),fr()}function fr(){const n=document.getElementById("coin-count");if(n){const e=Re();n.textContent=e.coins}}function Dl(n){J||Re(),J.leaguePoints=(J.leaguePoints||0)+n,J.leaguePoints<0&&(J.leaguePoints=0);const e=J.leaguePoints;e>=2e3?J.league="Profeta":e>=1200?J.league="Apóstol":e>=600?J.league="Evangelista":e>=200?J.league="Discípulo":J.league="Pescador",$t(),Du()}async function Du(){const n=localStorage.getItem("bb_player_id");if(n&&De)try{await Tg(We(De,"bb_users",n),{name:J.name,avatar:J.avatar,leaguePoints:J.leaguePoints||0,league:J.league||"Pescador",updatedAt:Ps()},{merge:!0})}catch(e){console.error("Error syncing player state to Firestore:",e)}}const lo=[];function tt(n){lo.push(n)}function xg(){return[...lo]}function Vu(n){return lo.find(e=>e.id===n)}const Qs=[{text:"Porque de tal manera amó Dios al mundo, que ha dado a su Hijo unigénito, para que todo aquel que en él cree, no se pierda, mas tenga vida eterna.",ref:"Juan 3:16"},{text:"Todo lo puedo en Cristo que me fortalece.",ref:"Filipenses 4:13"},{text:"Jehová es mi pastor; nada me faltará.",ref:"Salmos 23:1"},{text:"Confía en Jehová con todo tu corazón, y no te apoyes en tu propia prudencia.",ref:"Proverbios 3:5"},{text:"Y sabemos que a los que aman a Dios, todas las cosas les ayudan a bien.",ref:"Romanos 8:28"},{text:"No temas, porque yo estoy contigo; no desmayes, porque yo soy tu Dios.",ref:"Isaías 41:10"},{text:"Porque yo sé los pensamientos que tengo acerca de vosotros, dice Jehová, pensamientos de paz, y no de mal.",ref:"Jeremías 29:11"},{text:"El Señor es mi luz y mi salvación; ¿de quién temeré?",ref:"Salmos 27:1"},{text:"Mas el fruto del Espíritu es amor, gozo, paz, paciencia, benignidad, bondad, fe.",ref:"Gálatas 5:22"},{text:"Esforzaos y cobrad ánimo; no temáis, ni tengáis miedo de ellos.",ref:"Deuteronomio 31:6"},{text:"En el principio creó Dios los cielos y la tierra.",ref:"Génesis 1:1"},{text:"Clama a mí, y yo te responderé, y te enseñaré cosas grandes y ocultas que tú no conoces.",ref:"Jeremías 33:3"},{text:"Porque donde están dos o tres congregados en mi nombre, allí estoy yo en medio de ellos.",ref:"Mateo 18:20"},{text:"Yo soy el camino, la verdad y la vida; nadie viene al Padre sino por mí.",ref:"Juan 14:6"},{text:"Dad gracias en todo, porque esta es la voluntad de Dios para con vosotros en Cristo Jesús.",ref:"1 Tesalonicenses 5:18"},{text:"El amor es paciente, es bondadoso. El amor no es envidioso ni jactancioso ni orgulloso.",ref:"1 Corintios 13:4"},{text:"Porque por gracia sois salvos por medio de la fe; y esto no de vosotros, pues es don de Dios.",ref:"Efesios 2:8"},{text:"Venid a mí todos los que estáis trabajados y cargados, y yo os haré descansar.",ref:"Mateo 11:28"},{text:"He aquí, yo estoy a la puerta y llamo; si alguno oye mi voz y abre la puerta, entraré a él.",ref:"Apocalipsis 3:20"},{text:"Bienaventurados los pacificadores, porque ellos serán llamados hijos de Dios.",ref:"Mateo 5:9"},{text:"Lámpara es a mis pies tu palabra, y lumbrera a mi camino.",ref:"Salmos 119:105"},{text:"Amarás al Señor tu Dios con todo tu corazón, y con toda tu alma, y con toda tu mente.",ref:"Mateo 22:37"},{text:"Los cielos cuentan la gloria de Dios, y el firmamento anuncia la obra de sus manos.",ref:"Salmos 19:1"},{text:"No se amolden al mundo actual, sino sean transformados mediante la renovación de su mente.",ref:"Romanos 12:2"},{text:"Mira que te mando que te esfuerces y seas valiente; no temas ni desmayes.",ref:"Josué 1:9"},{text:"Ama a tu prójimo como a ti mismo.",ref:"Marcos 12:31"},{text:"Pedid, y se os dará; buscad, y hallaréis; llamad, y se os abrirá.",ref:"Mateo 7:7"},{text:"El Señor es bueno; es refugio en el día de la angustia, y conoce a los que en Él confían.",ref:"Nahúm 1:7"},{text:"Alégrate, joven, en tu juventud; y tome placer tu corazón en los días de tu adolescencia.",ref:"Eclesiastés 11:9"},{text:"Grande es el Señor y digno de toda alabanza; su grandeza es insondable.",ref:"Salmos 145:3"},{text:"Si Dios es por nosotros, ¿quién contra nosotros?",ref:"Romanos 8:31"},{text:"Yo he venido para que tengan vida, y para que la tengan en abundancia.",ref:"Juan 10:10"},{text:"Sean fuertes y valientes. No teman ni se asusten, porque el Señor su Dios siempre los acompañará.",ref:"Deuteronomio 31:6"},{text:"Así brille la luz de ustedes delante de todos, para que vean sus buenas obras y glorifiquen al Padre.",ref:"Mateo 5:16"},{text:"Encomienda al Señor tu camino; confía en él, y él actuará.",ref:"Salmos 37:5"},{text:"Instruye al niño en su camino, y aun cuando fuere viejo no se apartará de él.",ref:"Proverbios 22:6"},{text:"El que habita al abrigo del Altísimo morará bajo la sombra del Omnipotente.",ref:"Salmos 91:1"},{text:"Acerquémonos con confianza al trono de la gracia para recibir misericordia y hallar gracia.",ref:"Hebreos 4:16"},{text:"Deléitate asimismo en Jehová, y él te concederá las peticiones de tu corazón.",ref:"Salmos 37:4"},{text:"Con amor eterno te he amado; por tanto, te prolongué mi misericordia.",ref:"Jeremías 31:3"}];function xu(){const n=new Date,e=Math.floor((n-new Date(n.getFullYear(),0,0))/864e5);return Qs[e%Qs.length]}function Ng(n,e=[]){return Qs.filter(r=>!e.includes(r.ref)).sort(()=>Math.random()-.5).slice(0,n)}const kg=[{name:"María",avatar:"👩",score:2800,level:8},{name:"Daniel",avatar:"👦",score:2400,level:7},{name:"Sara",avatar:"👧",score:2100,level:6},{name:"José",avatar:"🧑",score:1800,level:5},{name:"Rebeca",avatar:"👩‍🦱",score:1500,level:5},{name:"David",avatar:"👨",score:1200,level:4},{name:"Esther",avatar:"👩‍🦰",score:900,level:3},{name:"Pablo",avatar:"🧔",score:600,level:2},{name:"Ana",avatar:"👱‍♀️",score:400,level:2},{name:"Samuel",avatar:"👶",score:200,level:1}];function Nu(){const n=Re(),e=[...kg,{name:n.name,avatar:n.avatar,score:n.totalScore,level:n.level,isCurrentPlayer:!0}];return e.sort((t,s)=>s.score-t.score),e.map((t,s)=>({...t,position:s+1}))}function co(){const n=Nu(),e=n.find(t=>t.isCurrentPlayer);return(e==null?void 0:e.position)||n.length}function Lg(n){var a,c;const e=Re(),t=xu(),s=xg(),r=co(),o=["linear-gradient(135deg, #4361ee, #6c83f7)","linear-gradient(135deg, #a855f7, #c084fc)","linear-gradient(135deg, #06d6a0, #34d399)","linear-gradient(135deg, #fb923c, #fdba74)","linear-gradient(135deg, #f472b6, #f9a8d4)"];n.innerHTML=`
  ...
  `,(d=document.getElementById("btn-change-avatar"))==null||d.addEventListener("click",()=>{var p;(p=document.getElementById("avatar-picker"))==null||p.classList.toggle("hidden")}),(h=document.getElementById("btn-close-avatar-picker"))==null||h.addEventListener("click",()=>{var p;(p=document.getElementById("avatar-picker"))==null||p.classList.add("hidden")}),document.querySelectorAll(".avatar-option").forEach(p=>{p.addEventListener("click",()=>{const E=p.dataset.avatar;Rg(E),document.getElementById("profile-avatar").textContent=E,document.querySelectorAll(".avatar-option").forEach(A=>A.classList.remove("selected")),p.classList.add("selected"),ee("Avatar actualizado ✅","success")})}),(f=document.getElementById("btn-edit-name"))==null||f.addEventListener("click",()=>{const p=prompt("Ingresa tu nombre:",e.name);p&&p.trim()&&(Pu(p.trim()),document.getElementById("profile-name").textContent=p.trim(),ee("Nombre actualizado ✅","success"))})}function Bg(n){const e=Fg(),t=Lu(),s=Mu(),r=Math.round(t/s*100);n.innerHTML=`
  ...
  `}const Ke={easy:[{q:"¿Quién construyó el arca?",options:["Abraham","Noé","Moisés","David"],answer:1,category:"Antiguo Testamento"},{q:"¿Cuántos días tomó crear Dios el mundo?",options:["5","6","7","3"],answer:1,category:"Creación"},{q:"¿Quién fue el primer hombre?",options:["Noé","Abel","Adán","Set"],answer:2,category:"Creación"},{q:"¿Quién fue la primera mujer?",options:["Sara","Eva","Rebeca","María"],answer:1,category:"Creación"},{q:"¿En qué ciudad nació Jesús?",options:["Nazaret","Jerusalén","Belén","Capernaúm"],answer:2,category:"Nuevo Testamento"},{q:"¿Cuántos discípulos tuvo Jesús?",options:["10","11","12","13"],answer:2,category:"Nuevo Testamento"},{q:"¿Quién mató a Goliat?",options:["Saúl","David","Jonatán","Sansón"],answer:1,category:"Antiguo Testamento"},{q:"¿Qué animal habló con Balaam?",options:["Un perro","Una burra","Un león","Una serpiente"],answer:1,category:"Antiguo Testamento"},{q:"¿De dónde era la madre de Jesús?",options:["Belén","Jerusalén","Nazaret","Egipto"],answer:2,category:"Nuevo Testamento"},{q:"¿Quién fue tragado por un gran pez?",options:["Pedro","Elías","Jonás","Daniel"],answer:2,category:"Antiguo Testamento"},{q:"¿Cuál fue el primer milagro de Jesús?",options:["Caminar sobre agua","Convertir agua en vino","Sanar un ciego","Multiplicar panes"],answer:1,category:"Milagros"},{q:"¿Quién bautizó a Jesús?",options:["Pedro","Juan el Bautista","Pablo","Santiago"],answer:1,category:"Nuevo Testamento"},{q:"¿En qué monte recibió Moisés los mandamientos?",options:["Carmelo","Sinaí","Ararat","Sión"],answer:1,category:"Antiguo Testamento"},{q:"¿Cuántos mandamientos dio Dios?",options:["5","7","10","12"],answer:2,category:"Antiguo Testamento"},{q:"¿Quién negó a Jesús tres veces?",options:["Judas","Pedro","Tomás","Juan"],answer:1,category:"Nuevo Testamento"},{q:"¿Cuántos libros tiene la Biblia?",options:["55","66","72","39"],answer:1,category:"General"},{q:"¿Quién fue el hermano de Moisés?",options:["Josué","Aarón","Caleb","Leví"],answer:1,category:"Antiguo Testamento"},{q:"¿Qué instrumento tocaba David?",options:["Flauta","Arpa","Trompeta","Tambor"],answer:1,category:"Antiguo Testamento"},{q:"¿Quién fue vendido por sus hermanos?",options:["Benjamín","José","Rubén","Judá"],answer:1,category:"Antiguo Testamento"},{q:"¿Cuál es el primer libro de la Biblia?",options:["Éxodo","Génesis","Salmos","Mateo"],answer:1,category:"General"},{q:"¿Qué símbolo apareció después del diluvio?",options:["Una estrella","Un arcoíris","Una paloma","Una nube"],answer:1,category:"Antiguo Testamento"},{q:"¿En qué se convirtió la esposa de Lot?",options:["Piedra","Estatua de sal","Arena","Ceniza"],answer:1,category:"Antiguo Testamento"},{q:"¿Quién era el rey más sabio?",options:["David","Salomón","Saúl","Josías"],answer:1,category:"Antiguo Testamento"},{q:"¿Qué fruta comieron Adán y Eva?",options:["Manzana","Fruto prohibido","Uva","Higo"],answer:1,category:"Creación"},{q:"¿Quién era el padre de Juan el Bautista?",options:["José","Zacarías","Simeón","Elías"],answer:1,category:"Nuevo Testamento"}],medium:[{q:"¿Cuántos años vivió Matusalén?",options:["800","900","969","1000"],answer:2,category:"Antiguo Testamento"},{q:"¿Quién era el padre de Salomón?",options:["Abraham","David","Saúl","Moisés"],answer:1,category:"Antiguo Testamento"},{q:"¿Qué profeta subió al cielo en un carro de fuego?",options:["Elías","Eliseo","Isaías","Jeremías"],answer:0,category:"Profetas"},{q:"¿Cuántos años duró el pueblo de Israel en el desierto?",options:["20","30","40","50"],answer:2,category:"Antiguo Testamento"},{q:"¿Quién interpretó los sueños del Faraón?",options:["Moisés","Daniel","José","Aarón"],answer:2,category:"Antiguo Testamento"},{q:"¿Quién escribió la mayor parte de los Salmos?",options:["Salomón","David","Moisés","Asaf"],answer:1,category:"Antiguo Testamento"},{q:"¿Cuál era la profesión de Pablo antes de ser apóstol?",options:["Pescador","Carpintero","Fabricante de tiendas","Recaudador"],answer:2,category:"Nuevo Testamento"},{q:"¿Quién fue el primer mártir cristiano?",options:["Pedro","Esteban","Santiago","Pablo"],answer:1,category:"Nuevo Testamento"},{q:"¿En qué isla estuvo exiliado Juan?",options:["Creta","Chipre","Patmos","Malta"],answer:2,category:"Nuevo Testamento"},{q:"¿Cuántas tribus de Israel había?",options:["10","11","12","13"],answer:2,category:"Antiguo Testamento"},{q:"¿Quién fue el sucesor de Moisés?",options:["Caleb","Josué","Aarón","Eleazar"],answer:1,category:"Antiguo Testamento"},{q:"¿Dónde fue crucificado Jesús?",options:["Monte Sión","Getsemaní","Gólgota","Betania"],answer:2,category:"Nuevo Testamento"},{q:"¿Quién fue arrojado al foso de los leones?",options:["Jonás","Daniel","Eliseo","Jeremías"],answer:1,category:"Antiguo Testamento"},{q:"¿Cuál es el libro más corto del Nuevo Testamento?",options:["Judas","2 Juan","3 Juan","Filemón"],answer:2,category:"General"},{q:"¿Quién fue la esposa de Abraham?",options:["Agar","Sara","Lea","Rebeca"],answer:1,category:"Antiguo Testamento"},{q:"¿Qué apóstol era recaudador de impuestos?",options:["Pedro","Mateo","Juan","Andrés"],answer:1,category:"Nuevo Testamento"},{q:"¿Cuántos panes usó Jesús para alimentar a 5000?",options:["3","5","7","12"],answer:1,category:"Milagros"},{q:"¿Quién traicionó a Jesús?",options:["Pedro","Tomás","Judas Iscariote","Bartolomé"],answer:2,category:"Nuevo Testamento"},{q:"¿Cómo murió Sansón?",options:["En batalla","Derribó el templo","Por enfermedad","Crucificado"],answer:1,category:"Antiguo Testamento"},{q:"¿Qué reina visitó a Salomón por su sabiduría?",options:["Jezabel","Ester","Reina de Sabá","Betsabé"],answer:2,category:"Antiguo Testamento"},{q:"¿Cuántos libros del Nuevo Testamento escribió Pablo?",options:["7","10","13","15"],answer:2,category:"General"},{q:"¿Quién fue el primer rey de Israel?",options:["David","Salomón","Saúl","Samuel"],answer:2,category:"Antiguo Testamento"},{q:"¿Qué lenguaje hablaba Jesús?",options:["Hebreo","Griego","Arameo","Latín"],answer:2,category:"General"},{q:"¿Quién cortó la oreja de un soldado en Getsemaní?",options:["Juan","Pedro","Santiago","Judas"],answer:1,category:"Nuevo Testamento"},{q:"¿Cuántos días estuvo Lázaro muerto antes de ser resucitado?",options:["2","3","4","7"],answer:2,category:"Milagros"}],hard:[{q:"¿Cuál es el versículo más corto de la Biblia?",options:["Juan 3:16","Juan 11:35","Éxodo 20:13","1 Tesalonicenses 5:16"],answer:1,category:"General"},{q:"¿Quién era Melquisedec?",options:["Un profeta","Rey y sacerdote de Salem","Un ángel","Un juez de Israel"],answer:1,category:"Antiguo Testamento"},{q:"¿Cuántos años reinó David en Jerusalén?",options:["20","33","40","45"],answer:1,category:"Antiguo Testamento"},{q:"¿Quién fue la primera persona en ver a Jesús resucitado?",options:["Pedro","Juan","María Magdalena","Tomás"],answer:2,category:"Nuevo Testamento"},{q:"¿En qué río fue bautizado Jesús?",options:["Nilo","Éufrates","Jordán","Tigris"],answer:2,category:"Nuevo Testamento"},{q:"¿Qué iglesia criticó Jesús por ser tibia?",options:["Éfeso","Sardis","Filadelfia","Laodicea"],answer:3,category:"Apocalipsis"},{q:"¿Quién era Nicodemo?",options:["Sacerdote","Fariseo","Saduceo","Centurión"],answer:1,category:"Nuevo Testamento"},{q:"¿Cuántos hijos tuvo Jacob?",options:["10","11","12","13"],answer:2,category:"Antiguo Testamento"},{q:"¿Qué profeta fue llamado por Dios siendo niño?",options:["Isaías","Jeremías","Samuel","Daniel"],answer:2,category:"Profetas"},{q:"¿Cuál es el salmo más largo?",options:["Salmo 23","Salmo 91","Salmo 119","Salmo 150"],answer:2,category:"General"},{q:"¿Quién fue el suegro de Moisés?",options:["Labán","Jetro","Ragüel","Éter"],answer:1,category:"Antiguo Testamento"},{q:"¿Cuántas plagas envió Dios a Egipto?",options:["7","9","10","12"],answer:2,category:"Antiguo Testamento"},{q:"¿Quién construyó el primer templo en Jerusalén?",options:["David","Salomón","Herodes","Zorobabel"],answer:1,category:"Antiguo Testamento"},{q:"¿Qué don especial tenía José el hijo de Jacob?",options:["Fuerza","Interpretar sueños","Profecía","Sabiduría"],answer:1,category:"Antiguo Testamento"},{q:"¿En qué libro se encuentra el capítulo del amor?",options:["Romanos","1 Corintios","Efesios","Filipenses"],answer:1,category:"Nuevo Testamento"},{q:"¿Cuántos jinetes del Apocalipsis hay?",options:["3","4","7","12"],answer:1,category:"Apocalipsis"},{q:"¿Quién era Barrabás?",options:["Discípulo","Sacerdote","Prisionero liberado","Soldado romano"],answer:2,category:"Nuevo Testamento"},{q:"¿En qué se transformó la vara de Moisés ante Faraón?",options:["Fuego","Serpiente","Flores","Agua"],answer:1,category:"Antiguo Testamento"},{q:"¿Quién escribió el Apocalipsis?",options:["Pablo","Pedro","Juan","Lucas"],answer:2,category:"General"},{q:"¿Cuántas puertas tiene la Nueva Jerusalén?",options:["7","10","12","24"],answer:2,category:"Apocalipsis"},{q:"¿Qué patriarca vivió en Ur de los Caldeos?",options:["Isaac","Abraham","Jacob","Noé"],answer:1,category:"Antiguo Testamento"},{q:"¿Quién era Bernabé?",options:["Apóstol original","Compañero de Pablo","Profeta del AT","Juez"],answer:1,category:"Nuevo Testamento"},{q:"¿Qué mujer se disfrazó para consultar a una médium?",options:["Jezabel","Saúl","Dalila","Mical"],answer:1,category:"Antiguo Testamento"},{q:"¿En qué batalla se detuvo el sol?",options:["Jericó","Gabaón","Hai","Betel"],answer:1,category:"Antiguo Testamento"},{q:"¿Qué apóstol fue arrebatado al tercer cielo?",options:["Juan","Pedro","Pablo","Santiago"],answer:2,category:"Nuevo Testamento"}]};function zg(n,e,t="easy"){const r={easy:1,medium:1.5,hard:2}[t]||1,o=Math.floor(e*.5*r),a=Math.floor(e*r);return{coins:Math.max(o,5),xp:Math.max(a,10)}}function ts(n,e,t=0,s="easy"){const r=zg(n,e,s);Zn(r.coins);const o=Xn(r.xp);if(o){const a=Re();ee(`🎉 ¡Subiste al nivel ${a.level}!`,"reward")}return setTimeout(()=>$g(),500),{...r,leveledUp:o}}function Gg(n){const s=[...Ke.easy.map(D=>({...D,diff:"easy"})),...Ke.medium.map(D=>({...D,diff:"medium"})),...Ke.hard.map(D=>({...D,diff:"hard"}))],r=Ve(s).slice(0,10);let o=0,a=0,c=0,d=0,h=null,f=20,p=!1;function E(){const D=r[o];p=!1,f=20;const k={easy:"Fácil",medium:"Medio",hard:"Difícil"},q={easy:"var(--color-success)",medium:"var(--color-gold)",hard:"var(--color-error)"};n.innerHTML=`
    ...
    `,A(),n.querySelectorAll(".trivia-option").forEach($=>{$.addEventListener("click",()=>{if(p)return;const N=parseInt($.dataset.index);R(N,D)})})}function A(){clearInterval(h);const D=document.getElementById("timer-ring"),k=2*Math.PI*42;h=setInterval(()=>{f--;const q=document.getElementById("timer-text");if(q&&(q.textContent=f),D){const $=k*(1-f/20);D.setAttribute("stroke-dashoffset",$),f<=5&&D.setAttribute("stroke","var(--color-error)")}f<=0&&(clearInterval(h),V())},1e3)}function R(D,k){p=!0,clearInterval(h);const q=n.querySelectorAll(".trivia-option"),$=D===k.answer;if(q.forEach((N,O)=>{N.disabled=!0,O===k.answer&&N.classList.add("correct"),O===D&&!$&&N.classList.add("wrong")}),$){c++,d++;const N=Math.floor(f*2),O={easy:10,medium:20,hard:30},T=10+N+(O[k.diff]||0);a+=T,d>=3&&Ie("streak_3"),f>=17&&Ie("fast_answer")}else d=0;setTimeout(()=>{o++,o<10?E():x()},1500)}function V(){p=!0,d=0;const D=r[o];n.querySelectorAll(".trivia-option").forEach((q,$)=>{q.disabled=!0,$===D.answer&&q.classList.add("correct")}),ee("⏰ ¡Se acabó el tiempo!","error"),setTimeout(()=>{o++,o<10?E():x()},1500)}function x(){var $,N;clearInterval(h);const D=Math.round(c/10*100);D===100&&Ie("perfect_trivia");const k=ts("trivia",a,c,"easy");es("trivia",a,c);const q=D>=80?"🏆":D>=60?"😊":D>=40?"🤔":"📖";n.innerHTML=`
    ...
    `,(V=document.getElementById("btn-more-clue"))==null||V.addEventListener("click",()=>{a++,d(p,E)}),n.querySelectorAll(".characters-option").forEach(x=>{x.addEventListener("click",()=>{const D=x.dataset.name;h(D,p)})})}function h(p,E,A){const R=p===E.name;if(n.querySelectorAll(".characters-option").forEach(V=>{V.disabled=!0,V.dataset.name===E.name&&V.classList.add("correct"),V.dataset.name===p&&!R&&V.classList.add("wrong")}),R){o++;const V=Math.max(50-a*10,10);r+=V,ee(`✅ ¡Correcto! +${V} pts`,"success")}else ee(`❌ Era: ${E.name}`,"error");setTimeout(()=>{s++,s<5?c():f()},1800)}function f(){var A,R;const p=ts("characters",r,o,"medium");es("characters",r,o);const E=o>=4?"🕵️":o>=3?"😊":"📖";n.innerHTML=`
      <div class="game-results">
    ...
    `,(A=document.getElementById("btn-play-again"))==null||A.addEventListener("click",()=>{me("game",{gameId:"characters"})}),(R=document.getElementById("btn-go-home"))==null||R.addEventListener("click",()=>{me("home")})}c()}function Jg(n){const t=Ve([...Qs]).slice(0,5);let s=0,r=0,o=0;function a(h){const f=h.text.split(" "),p=Math.min(3,Math.max(2,Math.floor(f.length/5))),E=[];for(;E.length<p;){const k=Math.floor(Math.random()*f.length);!E.includes(k)&&f[k].length>3&&E.push(k)}E.sort((k,q)=>k-q);const A=[],R=[];f.forEach((k,q)=>{if(E.includes(q)){const $=k.replace(/[.,;:!?¡¿"']/g,""),N=k.replace($,"");A.push({type:"blank",original:$,punct:N,index:R.length}),R.push($)}else A.push({type:"word",text:k})});const x=Ve(["gracia","verdad","camino","espíritu","gloria","pueblo","cielo","tierra","corazón","alma"].filter(k=>!R.includes(k.toLowerCase()))).slice(0,2),D=Ve([...R,...x]);return{blankedWords:A,missingWords:R,allOptions:D}}function c(){const h=t[s],{blankedWords:f,missingWords:p,allOptions:E}=a(h);let A=new Array(p.length).fill(null);function R(){var x;n.innerHTML=`
        <div class="verse-complete-game">
          ...
          <div class="verse-complete-text">
            ${f.map(D=>{if(D.type==="word")return`<span class="vc-word">${D.text}</span>`;{const k=A[D.index];return`<span class="vc-blank ${k?"filled":""}" data-blank="${D.index}">${k||"___"}${D.punct}</span>`}}).join(" ")}
          </div>

          <div class="section-title mt-lg">Elige las palabras:</div>
          <div class="vc-options">
            ${E.map(D=>{const k=A.includes(D);return`<button class="vc-option ${k?"used":""}" data-word="${D}" ${k?"disabled":""}>${D}</button>`}).join("")}
          </div>
      ...
      `,n.querySelectorAll(".vc-blank.filled").forEach(D=>{D.addEventListener("click",()=>{const k=parseInt(D.dataset.blank);A[k]=null,R()})}),n.querySelectorAll(".vc-option:not([disabled])").forEach(D=>{D.addEventListener("click",()=>{const k=D.dataset.word,q=A.indexOf(null);q!==-1&&(A[q]=k,R())})}),(x=document.getElementById("btn-check-verse"))==null||x.addEventListener("click",()=>{V(p)})}function V(x){let D=!0;x.forEach((k,q)=>{var $;(($=A[q])==null?void 0:$.toLowerCase())!==k.toLowerCase()&&(D=!1)}),D?(o++,r+=30,ee("✅ ¡Correcto! +30 pts","success")):ee(`❌ Respuesta: ${x.join(", ")}`,"error"),setTimeout(()=>{s++,s<5?c():d()},2e3)}R()}function d(){var p,E;const h=ts("verse-complete",r,o,"medium");es("verse-complete",r,o);const f=o>=4?"📖":o>=2?"😊":"🙏";n.innerHTML=`
      <div class="game-results">
    ...
    `,n.querySelectorAll(".btn-difficulty").forEach(s=>{s.addEventListener("click",r=>{const o=s.dataset.level;t(o)})})}function t(s){const o={easy:{size:11,wordCount:10,directions:[[0,1],[1,0]]},medium:{size:13,wordCount:11,directions:[[0,1],[1,0],[1,1]]},hard:{size:15,wordCount:12,directions:[[0,1],[1,0],[1,1],[0,-1],[-1,0]]}}[s],a=o.size,c=Ve([...Qg])[0],d=Ve([...c.words]).slice(0,o.wordCount);let h=[],f=[],p=!1,E=[],A=0,R=Date.now();function V(){h=Array.from({length:a},()=>Array.from({length:a},()=>""));const $=o.directions;d.forEach(O=>{let T=!1,_=0;for(;!T&&_<100;){_++;const v=$[Math.floor(Math.random()*$.length)],b=Math.floor(Math.random()*a),g=Math.floor(Math.random()*a),w=b+v[0]*(O.length-1),y=g+v[1]*(O.length-1);if(w<0||w>=a||y<0||y>=a)continue;let U=!0;for(let B=0;B<O.length;B++){const Y=b+v[0]*B,ae=g+v[1]*B;if(h[Y][ae]!==""&&h[Y][ae]!==O[B]){U=!1;break}}if(U){for(let B=0;B<O.length;B++){const Y=b+v[0]*B,ae=g+v[1]*B;h[Y][ae]=O[B]}T=!0}}});const N="ABCDEFGHIJKLMNOPQRSTUVWXYZ";for(let O=0;O<a;O++)for(let T=0;T<a;T++)h[O][T]===""&&(h[O][T]=N[Math.floor(Math.random()*N.length)])}function x(){n.innerHTML=`
        <div class="word-search-game">
          <div class="ws-header">
            <div class="ws-theme">
          ...
          <div class="ws-words-list">
            ${d.map(N=>`
              <span class="ws-word ${f.includes(N)?"found":""}">${N}</span>
            `).join("")}
          </div>

          <div class="ws-grid" id="ws-grid">
            ${h.map((N,O)=>N.map((T,_)=>`
                <div class="ws-cell" data-row="${O}" data-col="${_}">${T}</div>
              `).join("")).join("")}
          </div>

          <p class="text-sm text-muted text-center mt-md">Arrastra para seleccionar palabras consecutivas.</p>
        </div>
      `;const $=document.getElementById("ws-grid");$&&($.style.gridTemplateColumns=`repeat(${a}, 1fr)`),D()}function D(){const $=document.getElementById("ws-grid");if(!$)return;const N=b=>{const g=b.touches?b.touches[0]:b,w=document.elementFromPoint(g.clientX,g.clientY);return w&&w.classList.contains("ws-cell")?{row:parseInt(w.dataset.row),col:parseInt(w.dataset.col),el:w}:null},O=b=>{b.preventDefault(),p=!0,E=[];const g=N(b);g&&(E.push(g),g.el.classList.add("cell-selected"))},T=b=>{if(!p)return;b.preventDefault();const g=N(b);g&&!E.some(w=>w.row===g.row&&w.col===g.col)&&(E.length===1||v(g))&&(E.push(g),g.el.classList.add("cell-selected"))},_=()=>{p&&(p=!1,k(),document.querySelectorAll(".cell-selected").forEach(b=>b.classList.remove("cell-selected")),E=[])};function v(b){if(E.length<1)return!0;const g=E[0],w=E[E.length-1],y=Math.sign(w.row-g.row),U=Math.sign(w.col-g.col),B=w.row+y,Y=w.col+U;return b.row===B&&b.col===Y}$.addEventListener("mousedown",O),$.addEventListener("mousemove",T),window.addEventListener("mouseup",_),$.addEventListener("touchstart",O,{passive:!1}),$.addEventListener("touchmove",T,{passive:!1}),window.addEventListener("touchend",_)}function k(){if(E.length<2)return;const $=E.map(T=>h[T.row][T.col]).join(""),N=$.split("").reverse().join(""),O=d.find(T=>(T===$||T===N)&&!f.includes(T));if(O){f.push(O),A+=25,E.forEach(v=>{const b=document.querySelector(`.ws-cell[data-row="${v.row}"][data-col="${v.col}"]`);b&&b.classList.add("cell-found")});const T=Array.from(document.querySelectorAll(".ws-word")).find(v=>v.textContent===O);T&&T.classList.add("found");const _=document.querySelector(".ws-found");if(_&&(_.textContent=`${f.length} / ${d.length}`),ee(`✅ ¡Encontraste "${O}"!`,"success"),f.length===d.length){const v=Math.max(0,60-Math.floor((Date.now()-R)/1e3));A+=v,setTimeout(q,1e3)}}}function q(){var N,O;const $=ts("word-search",A,f.length,s);es("word-search",A,f.length),n.innerHTML=`
        <div class="game-results">
      ...
      `,(N=document.getElementById("btn-play-again"))==null||N.addEventListener("click",()=>{Ou(n)}),(O=document.getElementById("btn-go-home"))==null||O.addEventListener("click",()=>{me("home")})}V(),x()}}function Wg(n){const s=Ve([...Ei]).slice(0,6).map((R,V)=>[{id:V,type:"name",text:R.name,icon:"👤",pairId:V},{id:V,type:"clue",text:R.clues[0],icon:"💡",pairId:V}]).flat(),r=Ve(s);let o=[],a=[],c=0,d=0,h=Date.now(),f=!0;function p(){n.innerHTML=`
  ...
  `,n.querySelectorAll(".btn-start-story").forEach(e=>{e.addEventListener("click",t=>{const s=t.target.dataset.id;Yg(n,s)})})}function Yg(n,e){const t=Fu[e];let s=t.startNode||"start";function r(){var d;const o=t.nodes[s];if(!o){console.error(`Node not found: ${s}`);return}const a=o.image||t.cover;if(o.isEnd){Xg(n,t,o);return}n.innerHTML=`
    ...
    `,(d=document.getElementById("btn-exit-story"))==null||d.addEventListener("click",()=>{fo(n)});const c=document.getElementById("story-text-box");Zg(o.text,c,()=>{const h=document.getElementById("story-choices-container");h&&o.choices&&o.choices.forEach(f=>{const p=document.createElement("button");p.className="btn btn-option btn-glass fade-in",p.textContent=f.text,p.addEventListener("click",()=>{s=f.nextNode,r()}),h.appendChild(p)})})}r()}function Xg(n,e,t){var s;Zn(e.reward),Xn(e.xp),ee(`¡Historia completada! +${e.reward} monedas`,"success"),n.innerHTML=`
  ...
  `,(s=document.getElementById("btn-finish-story"))==null||s.addEventListener("click",()=>{fo(n)})}function Zg(n,e,t,s=25){let r=0;e.innerHTML="";function o(){r<n.length?(e.innerHTML+=n.charAt(r),r++,setTimeout(o,s)):t&&t()}o()}const xl=[{word:"JESUS",category:"Personaje",hint:"El Hijo de Dios, Salvador del mundo.",verse:'"Y dará a luz un hijo, y llamarás su nombre JESÚS, porque él salvará a su pueblo de sus pecados." - Mateo 1:21'},{word:"MOISES",category:"Personaje",hint:"Líder que guió al pueblo de Israel fuera de Egipto.",verse:'"Por la fe Moisés, hecho ya grande, rehusó llamarse hijo de la hija de Faraón." - Hebreos 11:24'},{word:"DAVID",category:"Personaje",hint:"Rey de Israel, conocido por vencer a Goliat y escribir Salmos.",verse:'"Hallé a David hijo de Isaí, varón conforme a mi corazón, quien hará todo lo que yo quiero." - Hechos 13:22'},{word:"SALOMON",category:"Personaje",hint:"Hijo de David, conocido por su gran sabiduría.",verse:'"Y dio Dios a Salomón sabiduría y prudencia muy grandes, y anchura de corazón." - 1 Reyes 4:29'},{word:"MANA",category:"Objeto/Alimento",hint:"El pan del cielo que Dios envió al pueblo en el desierto.",verse:'"Y la casa de Israel lo llamó Maná; y era como semilla de culantro, blanco, y su sabor como de hojuelas con miel." - Éxodo 16:31'},{word:"JERUSALEN",category:"Lugar",hint:"La ciudad santa, capital del Reino de Israel.",verse:'"Pedid por la paz de Jerusalén; sean prosperados los que te aman." - Salmos 122:6'},{word:"JORDAN",category:"Lugar",hint:"Río donde Juan el Bautista bautizó a Jesús.",verse:'"Y Jesús, después que fue bautizado, subió luego del agua; y he aquí los cielos le fueron abiertos." - Mateo 3:16'},{word:"BIBLIA",category:"Concepto",hint:"La palabra escrita de Dios (Colección de libros).",verse:'"Toda la Escritura es inspirada por Dios, y útil para enseñar, para redargüir." - 2 Timoteo 3:16'},{word:"ORACION",category:"Acción",hint:"Hablar con Dios con fe y corazón sincero.",verse:'"Orad sin cesar. Dad gracias en todo, porque esta es la voluntad de Dios." - 1 Tesalonicenses 5:17-18'},{word:"GOLIAT",category:"Personaje",hint:"El gigante filisteo de Gat que desafió a Israel.",verse:'"Salió entonces del campamento de los filisteos un paladín que se llamaba Goliat, de Gat." - 1 Samuel 17:4'},{word:"MESA",category:"Concepto",hint:'Lugar de comunión; "Aderezas ____ delante de mí".',verse:'"Aderezas mesa delante de mí en presencia de mis angustiadores; unges mi cabeza con aceite." - Salmos 23:5'},{word:"ARCA",category:"Objeto",hint:"Estructura construida por Noé para flotar en el Diluvio.",verse:'"Por la fe Noé... con temor preparó el arca en que su casa se salvase." - Hebreos 11:7'},{word:"TABERNACULO",category:"Lugar",hint:"Santuario móvil que usaba Israel en el desierto.",verse:'"Y harán un santuario para mí, y habitaré en medio de ellos." - Éxodo 25:8'},{word:"PENTATEUCO",category:"Concepto",hint:"Los primeros cinco libros de la Biblia escrito por Moisés.",verse:"Génesis, Éxodo, Levítico, Números y Deuteronomio forman la Ley."},{word:"ESPERANZA",category:"Concepto",hint:"Confianza segura en las promesas futuras de Dios.",verse:'"Y la esperanza no avergüenza; porque el amor de Dios ha sido derramado en nuestros corazones." - Romanos 5:5'},{word:"GRACIA",category:"Concepto",hint:"Favor inmerecido de Dios para la salvación.",verse:'"Porque por gracia sois salvos por medio de la fe; y esto no de vosotros." - Efesios 2:8'},{word:"ESTER",category:"Personaje",hint:"Reina judía que salvó a su pueblo de la destrucción.",verse:'"¿Y quién sabe si para esta hora has llegado al reino?" - Ester 4:14'},{word:"NOE",category:"Personaje",hint:"Construyó un arca para salvar a su familia y animales.",verse:'"Hizo así Noé; hizo conforme a todo lo que Dios le mandó." - Génesis 6:22'},{word:"MARIA",category:"Personaje",hint:"Madre de Jesús en su forma humana.",verse:'"Engrandece mi alma al Señor; y mi espíritu se regocija en Dios mi Salvador." - Lucas 1:46-47'},{word:"PABLO",category:"Personaje",hint:"Apóstol de los gentiles, escribió muchas epístolas.",verse:'"Para mí el vivir es Cristo, y el morir es ganancia." - Filipenses 1:21'},{word:"PEDRO",category:"Personaje",hint:"Pescador que llegó a ser el líder de los apóstoles.",verse:'"Tú eres el Cristo, el Hijo del Dios viviente." - Mateo 16:16'},{word:"SANSON",category:"Personaje",hint:"Juez dotado de fuerza sobrehumana por el Espíritu de Dios.",verse:'"Y el Espíritu de Jehová vino sobre él con poder." - Jueces 14:19'},{word:"JONAS",category:"Personaje",hint:"Profeta que fue tragado por un gran pez por desobedecer.",verse:'"Pero Jehová tenía preparado un gran pez que tragase a Jonás." - Jonás 1:17'},{word:"DANIEL",category:"Personaje",hint:"Profeta que sobrevivió al foso de los leones.",verse:'"Mi Dios envió su ángel, el cual cerró la boca de los leones." - Daniel 6:22'},{word:"ELIAS",category:"Personaje",hint:"Profeta arrebatado al cielo en un carro de fuego.",verse:'"Y Elías subió al cielo en un torbellino." - 2 Reyes 2:11'},{word:"BELEN",category:"Lugar",hint:"Ciudad de Judea donde nació Jesucristo.",verse:'"Y tú, Belén... de ti saldrá un guiador que apacentará a mi pueblo." - Mateo 2:6'},{word:"NAZARET",category:"Lugar",hint:"Ciudad de Galilea donde creció Jesús.",verse:'"¿De Nazaret puede salir algo bueno? Le dijo Felipe: Ven y ve." - Juan 1:46'},{word:"MILAGRO",category:"Concepto",hint:"Hecho sobrenatural que manifiesta el poder de Dios.",verse:'"Y hacían muchos milagros y señales por mano de los apóstoles." - Hechos 5:12'},{word:"PARABOLA",category:"Concepto",hint:"Narración breve que transmite una enseñanza espiritual.",verse:'"Todo esto habló Jesús por parábolas a la gente." - Mateo 13:34'},{word:"FE",category:"Concepto",hint:"La certeza de lo que se espera, la convicción de lo que no se ve.",verse:'"Es, pues, la fe la certeza de lo que se espera..." - Hebreos 11:1'},{word:"AMOR",category:"Concepto",hint:"El vínculo perfecto y el mayor mandamiento.",verse:'"Y ahora permanecen la fe, la esperanza y el amor; pero el mayor es el amor." - 1 Corintios 13:13'},{word:"PAZ",category:"Concepto",hint:'Fruto del Espíritu; "La ____ de Dios que sobrepasa todo entendimiento".',verse:'"La paz os dejo, mi paz os doy; yo no os la doy como el mundo la da." - Juan 14:27'},{word:"REDENCION",category:"Concepto",hint:"Rescate o liberación pagada por la sangre de Cristo.",verse:'"En quien tenemos redención por su sangre, el perdón de pecados." - Efesios 1:7'},{word:"SABIDURIA",category:"Concepto",hint:"Temor de Dios es el principio de la _________.",verse:'"El principio de la sabiduría es el temor de Jehová." - Proverbios 1:7'},{word:"ALELUYA",category:"Concepto",hint:'Expresión de júbilo que significa "Alabad a Dios".',verse:'"¡Aleluya! Alabad a Dios en su santuario." - Salmos 150:1'},{word:"DISCIPULO",category:"Concepto",hint:"Seguidor o aprendiz de las enseñanzas de Jesús.",verse:'"En esto conocerán todos que sois mis discípulos, si tuviereis amor." - Juan 13:35'}];function ey(n){let e=o(),t=[],s=6,r=!1;function o(){let f=JSON.parse(localStorage.getItem("hm_played_words")||"[]"),p=xl.filter(R=>!f.includes(R.word));p.length===0&&(f=[],p=[...xl]);const E=Math.floor(Math.random()*p.length),A=p[E];return f.push(A.word),localStorage.setItem("hm_played_words",JSON.stringify(f)),A}function a(){if(r){h();return}const f=e.word.toUpperCase();if(f.split("").every(E=>t.includes(E)||E===" ")){d(!0);return}if(s<=0){d(!1);return}n.innerHTML=`
      <div class="hangman-game">
        ...
        <div class="hm-word-display" id="hm-word-display">
          ${f.split("").map(E=>`
            <div class="hm-letter-box ${E===" "?"hm-space":""}">
              ${t.includes(E)||E===" "?E:"_"}
            </div>
          `).join("")}
        </div>
        ...
        <div class="hm-keyboard" id="hm-keyboard">
          ${"ABCDEFGHIJKLMNÑOPQRSTUVWXYZ".split("").map(E=>`
            <button class="btn btn-keyboard" 
                    data-letter="${E}" 
                    ${t.includes(E)?"disabled":""}>
              ${E}
            </button>
          `).join("")}
        </div>
      </div>
    `,n.querySelectorAll(".btn-keyboard").forEach(E=>{E.addEventListener("click",A=>{const R=A.target.dataset.letter;c(R)})})}function c(f){if(t.includes(f))return;t.push(f),e.word.toUpperCase().includes(f)?ee("¡Correcto!","success"):(s--,ee("¡Letra incorrecta!","warning")),a()}function d(f){r=!0,f&&(Zn(50),Xn(25)),h(f)}function h(f){var p;n.innerHTML=`
      <div class="hangman-game">
    ...
    `,(p=document.getElementById("btn-restart-hm"))==null||p.addEventListener("click",()=>{e=o(),t=[],s=6,r=!1,a()})}a()}function ty(n){const e=Re(),t=localStorage.getItem("bb_player_id")||A();localStorage.setItem("bb_player_id",t);let s=null,r=null,o=null,a=null,c="p1",d=10,h=null,f=!1,p={fiftyfifty:!0,freeze:!0,double:!0},E=!1;function A(){return"user_"+Math.random().toString(36).substr(2,9)}function R(){var g,w,y,U,B,Y;n.innerHTML=`
    ...
    `,(g=document.getElementById("btn-mode-random"))==null||g.addEventListener("click",()=>{V(),q()}),(w=document.getElementById("btn-mode-create"))==null||w.addEventListener("click",()=>{x()}),(y=document.getElementById("btn-mode-join"))==null||y.addEventListener("click",()=>{D()}),(U=document.getElementById("btn-back-home"))==null||U.addEventListener("click",()=>{me("home")}),(B=document.getElementById("btn-open-leaderboard"))==null||B.addEventListener("click",()=>{document.getElementById("bb-leaderboard-modal").style.display="flex",k()}),(Y=document.getElementById("close-leaderboard"))==null||Y.addEventListener("click",()=>{document.getElementById("bb-leaderboard-modal").style.display="none"})}function V(){var g;n.innerHTML=`
      <div class="bible-battle-game">
    ...
    `,(g=document.getElementById("btn-cancel-match"))==null||g.addEventListener("click",()=>{a&&a(),R()})}async function x(){var w,y;const g=Math.random().toString(36).substr(2,4).toUpperCase();n.innerHTML=`
      <div class="bible-battle-game">
        <div class="bb-private-room">
          ...
          <div class="bb-room-code" id="room-code-display">${g}</div>
    ...
    `,(w=document.getElementById("btn-cancel-room"))==null||w.addEventListener("click",()=>{o&&o(),R()}),(y=document.getElementById("btn-copy-code"))==null||y.addEventListener("click",()=>{navigator.clipboard.writeText(g),ee("¡Código copiado!","info")});try{c="p1";const U=Ve([...Ke.easy,...Ke.medium]).slice(0,5),B=await Kr(jt(De,"bb_matches"),{status:"waiting_friend",code:g,p1:{uid:t,name:e.name,avatar:e.avatar,score:0,currentQ:0,lastAnswered:-1},p2:null,questions:U,createdAt:Ps()});$(B.id)}catch(U){ee("Error creando sala: "+U.message,"danger"),R()}}function D(){var g,w;n.innerHTML=`
      <div class="bible-battle-game">
        <div class="bb-private-room">
          <div class="bb-room-icon">🔑</div>
          <h3>Unirse a Sala</h3>
    ...
    `,(g=document.getElementById("btn-cancel-join"))==null||g.addEventListener("click",()=>{R()}),(w=document.getElementById("btn-confirm-join"))==null||w.addEventListener("click",async()=>{const y=document.getElementById("input-room-code").value.trim().toUpperCase();if(y.length<4){ee("Ingresa un código válido de 4 letras.","warning");return}try{const U=Jr(jt(De,"bb_matches"),Qr("status","==","waiting_friend"),Qr("code","==",y)),B=await Wr(U);if(B.empty){ee("Sala no encontrada o llena.","warning");return}const Y=B.docs[0];c="p2",await ws(We(De,"bb_matches",Y.id),{status:"playing",p2:{uid:t,name:e.name,avatar:e.avatar,score:0,currentQ:0,lastAnswered:-1}}),$(Y.id)}catch(U){ee("Error al unirse: "+U.message,"danger")}})}async function k(){const g=document.getElementById("leaderboard-list");if(g)try{const w=Jr(jt(De,"bb_users"),Eg("leaguePoints","desc"),Il(10)),y=await Wr(w);if(y.empty){g.innerHTML='<p class="text-center text-muted">Aún no hay clasificados. ¡Sé el primero!</p>';return}g.innerHTML=`
        <div class="ranking-list">
      ...
      `}catch(w){console.error(w),g.innerHTML='<p class="text-center text-danger">Error cargando ranking.</p>'}}async function q(){const g=jt(De,"bb_queue"),w=Jr(g,Qr("status","==","waiting"),Il(10));try{const U=(await Wr(w)).docs.find(B=>B.data().uid!==t);if(U){const B=U.data();c="p2";const Y=Ve([...Ke.easy,...Ke.medium]).slice(0,5),ae=await Kr(jt(De,"bb_matches"),{status:"starting",p1:{uid:B.uid,name:B.name,avatar:B.avatar,score:0,currentQ:0,lastAnswered:-1},p2:{uid:t,name:e.name,avatar:e.avatar,score:0,currentQ:0,lastAnswered:-1},questions:Y,startTime:Ps()});await ws(We(De,"bb_queue",U.id),{status:"matched",matchId:ae.id}),$(ae.id)}else{c="p1";const B=await Kr(jt(De,"bb_queue"),{uid:t,name:e.name,avatar:e.avatar,status:"waiting",createdAt:Ps()});a=Cl(We(De,"bb_queue",B.id),Y=>{if(Y.exists()&&Y.data().status==="matched"){const ae=Y.data().matchId;a(),Rl(B),$(ae)}})}}catch(y){console.error("Matchmaking error:",y),ee("Error de conexión: "+y.message,"danger")}}function $(g){s=g,o=Cl(We(De,"bb_matches",g),w=>{w.exists()&&(r=w.data(),r.status==="starting"?N("playing"):O())})}async function N(g){s&&await ws(We(De,"bb_matches",s),{status:g})}function O(){if(!r)return;const g=r[c],y=r[c==="p1"?"p2":"p1"],U=g.currentQ;if(U>=5||r.status==="ended"){clearInterval(h),b();return}const B=r.questions[U];n.innerHTML=`
      <div class="bible-battle-game">
        <div class="bb-hud">
          <div class="bb-player">
    ...
    `,f=!1,T(),_(B.answer)}function T(){clearInterval(h),d=10;const g=n.querySelector(".timer-fill");h=setInterval(async()=>{d-=.1,g&&(g.style.width=`${d/10*100}%`),d<=0&&(clearInterval(h),f||v(-1,-1))},100)}function _(g){var w,y,U;n.querySelectorAll(".btn-option").forEach(B=>{B.addEventListener("click",Y=>{if(f)return;f=!0;const ae=parseInt(B.dataset.ans);v(ae,g)})}),(w=document.getElementById("p-5050"))==null||w.addEventListener("click",()=>{if(!p.fiftyfifty||f)return;p.fiftyfifty=!1;let Y=Array.from(n.querySelectorAll(".btn-option")).filter(ae=>parseInt(ae.dataset.ans)!==g);Ve(Y).slice(0,2).forEach(ae=>ae.style.visibility="hidden"),document.getElementById("p-5050").classList.add("disabled")}),(y=document.getElementById("p-double"))==null||y.addEventListener("click",()=>{!p.double||f||(p.double=!1,E=!0,document.getElementById("p-double").classList.add("disabled"),ee("¡Próximo acierto duplicado!","info"))}),(U=document.getElementById("p-freeze"))==null||U.addEventListener("click",()=>{p.freeze&&(p.freeze=!1,document.getElementById("p-freeze").classList.add("disabled"),ee("❄️ Efecto visual de Hielo","info"))})}async function v(g,w){clearInterval(h);let y=0;g===w?(y=Math.floor(d*10*(E?2:1)),ee("¡Correcto!","success")):ee("¡Incorrecto!","warning"),E=!1;const U=r[c],B={};B[`${c}.score`]=U.score+y,B[`${c}.currentQ`]=U.currentQ+1,B[`${c}.lastAnswered`]=g,await ws(We(De,"bb_matches",s),B)}function b(){var Y,ae;o&&o();const g=r[c],y=r[c==="p1"?"p2":"p1"],U=g.score>y.score,B=g.score===y.score;U?(Zn(100),Xn(50),Dl(25)):B||Dl(-10),Du(),n.innerHTML=`
      <div class="game-results">
        <div class="results-emoji">${U?"🏆":B?"🤝":"😢"}</div>
        <h2 class="results-title">${U?"¡Victoria!":B?"¡Empate!":"¡Derrota!"}</h2>

        <div class="results-score-circle">
          <span class="results-score-value">${g.score}</span>
    ...
    `,(Y=document.getElementById("btn-play-again-bb"))==null||Y.addEventListener("click",()=>{R()}),(ae=document.getElementById("btn-go-home"))==null||ae.addEventListener("click",()=>{me("home")}),setTimeout(()=>{c==="p1"&&Rl(We(De,"bb_matches",s))},5e3)}R()}function ny(n){let e=0,t=3,s=1,r=0,o=!1,a=null,c=[],d=null;const h=["#ef233c","#4361ee","#2ec4b6","#ffb703","#9b5de5"],f=["bomb","gold","freeze"];function p(){E(),A()}function E(){var v;const N=[...Ke.easy,...Ke.medium];a=N[Math.floor(Math.random()*N.length)],c=[];const O=Ve([...a.options]),T=((v=n.querySelector(".bbp-game-arena"))==null?void 0:v.clientWidth)||400,_=a.options[a.answer];O.forEach((b,g)=>{const w=b===_,y=Math.random()<.2;let U="normal";y&&(U=f[Math.floor(Math.random()*f.length)]),c.push({id:"bal_"+Date.now()+"_"+g,text:b,isCorrect:w,type:U,x:g*(T/O.length)+20,y:-120,speed:(1.2+Math.random()*.8)*s,color:U==="bomb"?"#2b2b2b":U==="gold"?"#ffd700":U==="freeze"?"#00f5d4":h[g%h.length],size:70+Math.random()*10})}),c.some(b=>b.isCorrect)||(c[0].isCorrect=!0),k()}function A(N){if(o)return;const O=n.querySelector(".bbp-game-arena");if(!O){d=requestAnimationFrame(A);return}const T=O.clientHeight;for(let _=c.length-1;_>=0;_--){const v=c[_];v.y+=v.speed;let b=document.getElementById(v.id);b||(b=document.createElement("div"),b.id=v.id,b.className=`balloon ${v.type}`,b.style.backgroundColor=v.color,b.style.width=v.size+"px",b.style.height=v.size*1.2+"px",b.innerHTML=`
          <div class="balloon-content">${v.text}</div>
          <div class="balloon-string"></div>
          ${v.type!=="normal"?`<div class="balloon-badge">${v.type==="bomb"?"💣":v.type==="gold"?"⭐":"❄️"}</div>`:""}
        `,b.addEventListener("click",()=>R(v)),O.appendChild(b)),b.style.left=v.x+"px",b.style.bottom=v.y+"px",T>100&&v.y>T+150&&(b.remove(),c.splice(_,1),v.isCorrect&&v.type!=="bomb"&&(t--,ee("¡Se escapó la respuesta!","warning"),D(),o||E()))}o||(d=requestAnimationFrame(A))}function R(N){if(o)return;const O=document.getElementById(N.id);if(O&&(x(N.x+N.size/2,V()-N.y-N.size/2,N.color),O.remove()),c=c.filter(T=>T.id!==N.id),N.type==="bomb"){t--,ee("¡BOOM! Globo Bomba 💣","danger"),D();return}if(N.isCorrect){let T=10;N.type==="gold"&&(T=20),e+=T,r++,ee(N.type==="gold"?"¡Doble Puntos! 🌟":"¡Correcto! 🎉","success"),s=1+r*.05,N.type==="freeze"&&(s=.5,ee("¡Tiempo Congelado! ❄️","info"),setTimeout(()=>{o||(s=1+r*.05)},4e3)),E()}else t--,ee("¡Incorrecto! 💔","warning"),D();q()}function V(){var N;return((N=n.querySelector(".bbp-game-arena"))==null?void 0:N.clientHeight)||400}function x(N,O,T){const _=n.querySelector(".bbp-game-arena");if(_)for(let v=0;v<8;v++){const b=document.createElement("div");b.className="bbp-particle",b.style.backgroundColor=T,b.style.left=N+"px",b.style.top=O+"px";const g=Math.random()*Math.PI*2,w=2+Math.random()*4;b.style.setProperty("--dx",Math.cos(g)*w*20+"px"),b.style.setProperty("--dy",Math.sin(g)*w*20+"px"),_.appendChild(b),setTimeout(()=>b.remove(),600)}}function D(){t<=0?(o=!0,cancelAnimationFrame(d),Zn(Math.floor(e/2)),Xn(e),$()):q()}function k(){n.innerHTML=`
      <div class="bbp-game">
        <div class="bbp-hud">
